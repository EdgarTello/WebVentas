(function() {
  ...
  now = function() {
    var ref;
    return (ref = typeof performance !== "undeed" && performance !== null ? typeof performance.now === "function" ? performance.now() : void 0 : void 0) != null ? ref : +(new Date);
  };
  ...
  getFromDOM = function(key, json) {
    ...
    try {
      ...
      e = error;
      return typeof console !== "undeed" && console !== null ? console.error("Error parsing inline pace options", e) : void 0;
    }
  };
    ...
    for (key in from.prototype) {
      try {
        if ((to[key] == null) && typeof from[key] !== 'function') {
          if (typeof Object.deeProperty === 'function') {
            results.push(Object.deeProperty(to, key, {
              get: function() {
