<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.GestorDocumental.Usuario.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
            ...
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-center">
                    <div class="col-12 col-md">
                        <h4 class="text-body mb-0" data-anchor="data-anchor">Listado de Usuario</h4>
                    ...
                    <div class="col col-md-auto">                
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                            <button id="btnagregar" class="btn btn-primary me-1 mb-1" type="button"><i class="fa-solid fa-plus me-2"></i>Agregar Usuario</button>
                            <select class="form-select-sm me-1 mb-1" id="cborol"></select>
                            <input id="busqueda" class="form-control-sm me-1 mb-1"  type="text" maxlength="20" onkeypress="return isAlphanumericKey(event)" placeholder="NOMBRE"  />
        ...
        <script src="../../../plugins/jquery/gestordocumental/usuario/jquery.listadoweb-1.2.0.js"></script>
    </body>
