<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.GestorDocumental.Local.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
            ...
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-center">
                    <div class="col-12 col-md">
                        <h4 class="text-body mb-0" data-anchor="data-anchor">Listado de Locales</h4>
                        ...
                        <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("LocalList") %>" />
                    </div>
                    <div class="col col-md-auto">                
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                            <button id="btnagregar" class="btn btn-primary me-1 mb-1" type="button"><i class="fa-solid fa-plus me-2"></i>Agregar Local</button>
                            <input id="busqueda" class="form-control-sm"  type="text" maxlength="20" onkeypress="return isAlphanumericKey(event)" placeholder="NOMBRE"  />
                            ...
                            <table id="tbldetalle" class="table table-sm fs-9 mb-0 overflow-hidden">
                                <thead class="text-body bg-body-highlight">
                                    <tr>
                                        ...
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:550px;" data-sort="nombre">NOMBRE</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:550px;" data-sort="direccion">DIRECCION</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:100px;" data-sort="distrito">DISTRITO</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:100px;" data-sort="telefono">TELEFONO</th>
                                        <th class="sort align-middle ps-4" scope="col" style="width:50px;">ACTIVO</th>
        ...
        <script src="../../../plugins/jquery/gestordocumental/local/jquery.listadoweb-1.2.0.js"></script>
    </body>
