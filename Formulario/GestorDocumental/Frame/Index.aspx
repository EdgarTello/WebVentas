<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.GestorDocumental.Frame.Index" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                        <li class="nav-item">
                        <!-- parent pages-->
                        <div class="nav-item-wrapper d-none" id="divmodule">
        ...
        <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav w-100 d-flex align-items-center">                   
                    <li class="nav-item nav-local">
                        <a class="nav-link">LOCAL:</a>
                    </li>
                    <li class="nav-item me-auto">
                        <form id="formdocument" asp-antiforgery="false" runat="server">
                            <asp:DropDownList ID="local" CssClass="form-select mb-3" runat="server"></asp:DropDownList>
                        </form>
                    </li>
        ...
        <script src="../../../plugins/jquery/gestordocumental/frame/jquery.indexweb-1.0.2.js"></script>
