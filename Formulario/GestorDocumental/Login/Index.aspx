<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.GestorDocumental.Login.Index" %>
<!DOCTYPE html>
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    <head>
        ...
        <meta property="og:title" content="ERP: un pago rápido - RPE" />
        <meta property="og:description" content="Nos preocupamos por darle un mejor soporte!" />
        <meta property="og:url" content="http://rpe-document.com/soporte" />
	...
	<body>
                                    ...
                                    <div class="row align-items-center gx-0 gy-7">
                                        <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                                            ...
                                            <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                                                <h3 class="mb-3 text-body-emphasis fs-7">RDocument</h3>
                                                <p class="text-body-tertiary">Acceda a su sistema de archivo digital RICOH, Gestione, busque y resguarde sus documentos con total seguridad.!</p>
                                        ...
                                        <div class="col mx-auto">
                                            <div class="auth-form-box">
                                               ...
                                               <%-- <div class="mb-3 text-start">
                                                ...
                                                <div class="mb-3 text-start">
                                                   <div class="form-floating">
                                                        <input runat="server" class="form-control form-icon-input pe-6" id="usuario" type="text" maxlength="40" placeholder="Usuario"/>
        ...
        <script src="../../../plugins/jquery/gestordocumental/login/jquery.listadoweb-1.0.1.js"></script>
