<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.GestorDocumental.LocalPerfil.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de LocalAreaes</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h1>Edición de Perfil Local:<span id="slocalnombre"></span> - <span id="sareanombre"></span>
                                    </h1>
...
<script src="../../../plugins/jquery/gestordocumental/localperfil/jquery.nuevoweb-1.0.5.js"></script>
<!-- AdminLTE App -->
