<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.GestorDocumental.Indice.Listado" %>
...
<body>
				...
				<div class="card-body" style="padding: 0.5rem !important;">
					<div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-8">
                                 <h1>
							        Archivador - <span id="snombre"></span>
						        </h1>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" style="color:black">Gestor Documental</h3>
    ...
    <script src="../../../plugins/jquery/gestordocumental/indice/jquery.listadoweb-1.0.3.js"></script>
    <!-- AdminLTE App -->
