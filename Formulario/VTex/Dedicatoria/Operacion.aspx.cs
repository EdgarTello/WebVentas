...
namespace TwoTecnology.WebVentas.Formulario.VTex.Dedicatoria
{
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                Metodos.ValidateAntiXsrfToken("DedicationList");

                if (!order.IsInyection() &&
            ...
            if (Request.QueryString["ope"] == "20")
            {
                ...
                string sreporte = Server.MapPath("~/Rpt/R002-1000.rdlc");
                ...
                if (id.IsNumeric())
                {
                    using (TwoTecnology.Repositorio.VTex.ItemOrder obj = new TwoTecnology.Repositorio.VTex.ItemOrder())
                    {
                        obj.UpdatePrinter(empresa_ruc, id);
