<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.VTex.Dedicatoria.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
        <div class="card shadow-none border mb-3" data-component-card="data-component-card">
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-end mb-1">
                   <div class="col-auto">
                        <h4 class="text-body mb-0">Listado de Dedicatorias</h4>
                        ...
                        <input type="hidden" name="hautorefrescar" id="hautorefrescar" value="0" runat="server"/>
                        ...
                        <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("DedicationList") %>" />
                    </div>    
                        ...
                        <div class="table-responsive scrollbar mb-3">
                            <div class="col-12">
                                <ul class="nav nav-links mx-n2">
                                    ...
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 0);"><span>NO Impreso</span><span id="snoprint" class="text-body-tertiary fw-semibold"></span></a></li>
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 1);"><span>Impreso</span><span id="sprint" class="text-body-tertiary fw-semibold"></span></a></li>
                                </ul>
                            </div>
                            <table id="tbldetalle" class="table table-sm fs-9 mb-0 overflow-hidden table-hover">
                                <thead class="text-body bg-body-highlight">
                                    <tr>
                                        ...
                                        <th class="sort text-center align-middle pe-0 ps-4"      scope="col">PDF</th>
                                        <th class="sort text-center white-space-nowrap align-middle ps-4" scope="col" data-sort="orderid">ORDEN ID</th>
                                        <th class="sort text-center white-space-nowrap align-middle ps-4" scope="col">CLIENTE</th>                                        
                                        <th class="sort text-center white-space-nowrap align-middle ps-4" scope="col" data-sort="paymentname">FORMA PAGO</th>
                                        ...
                                        <th class="sort text-center white-space-nowrap align-middle ps-4" scope="col">IMPRESO</th>
                                    </tr>
                                </thead>
        ...
        <script src="../../../plugins/jquery/vtex/dedicatoria/jquery.listadoweb-3.1.0.js"></script>
    </body>
