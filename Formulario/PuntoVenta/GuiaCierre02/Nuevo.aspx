<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.GuiaCierre02.Nuevo" %>
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="bultos" id="bultos" value=""  maxlength="7" class="form-control" onkeypress="return isNumberKey(event)" required="required" runat="server"/>
                                </div>
...
<!-- ./wrapper -->
    ...
    <script src="../../../plugins/jquery/puntoventa/GuiaCierre02/jquery.nuevoweb-1.1.0.js"></script>
    <!-- AdminLTE App -->
