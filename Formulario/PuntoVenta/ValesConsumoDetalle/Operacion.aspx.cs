    ...
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                using (Repositorio.ValesConsumoDetalle obj = new TwoTecnology.Repositorio.ValesConsumoDetalle())
                {
                    respuesta = obj.LoadByValeConsumo(idvaleconsumo).Serialize();
                }
            }
            ...
            if (Request.QueryString["ope"] == "1_1")
            {
                ...
                using (Repositorio.ValesConsumoDetalle obj = new TwoTecnology.Repositorio.ValesConsumoDetalle())
                {
                    respuesta = obj.LoadByCodigoSaldo(id,  monto);
                }
            }
