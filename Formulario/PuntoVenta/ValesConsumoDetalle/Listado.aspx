<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ValesConsumoDetalle.Listado" %>
...
<body>
    <form id="formulario" name="formulario" runat="server" >
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="hidden" name="hidvaleconsumo" id="hidvaleconsumo" value="0" runat="server" />

                                    <input type="hidden" name="hanulado" id="hanulado" value="0" runat="server" />
                                    <input type="hidden" name="hvencido" id="hvencido" value="0" runat="server" />
        ...
        <div class="modal fade" id="dialogeliminar" tabindex="-1" role="dialog" aria-labelledby="dialogAnularItemLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="H2">Cupon</h5>
        ...
        <div class="modal" id="dialogcliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" style="color:black">Busqueda de Cliente</h3>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
                        <div class="row">
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="busqueda" name="busqueda"  placeholder="Nombre, Documento, Telefono" required="required" />
                                </div>
                                <div class="col-lg-2">
                                    <a href="#" onclick="buscarcliente();">
    ...
    <script src="../../../plugins/jquery/puntoventa/valesconsumodetalle/jquery.listadoweb-3.0.7.js"></script>
