...
namespace TwoTecnology.WebVentas.Formulario.PuntoVenta.ProductoImpuesto
{
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string ipProductoImpuesto = ticket.UserData.Split('|')[9];
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                using (Repositorio.Impuesto obj = new TwoTecnology.Repositorio.Impuesto())
                {
                    respuesta = obj.LoadByProducto(idproducto).Serialize();
                }
            }
