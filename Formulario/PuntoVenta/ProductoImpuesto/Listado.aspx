<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ProductoImpuesto.Listado" %>
    ...
    <head runat="server">
      ...
      <title>Listado de Producto Impuesto</title>
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h1>
                                            Producto Impuestos - <span id="snombre"></span>
                                        </h1>
                                        <input type="hidden" name="hidproducto" id="hidproducto" value="" runat="server" />
                                    </div>
...
<script src="../../../plugins/jquery/puntoventa/productoimpuesto/jquery.listadoweb-1.0.7.js"></script>
