<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ProductoImpuesto.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de ProductoImpuestos</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h1>Edición de Producto Impuestos - <span id="snombre"></span>
                                    </h1>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select  name="cbotipo" id="cboimpuesto" class="form-control"></select>
                                </div>
                                <div class="col-lg-3">
...
<script src="../../../plugins/jquery/puntoventa/productoimpuesto/jquery.nuevoweb-1.0.7.js"></script>
<!-- AdminLTE App -->
