<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.LlevarPendiente.Listado" %>
...
<body onhashchange="changebody(event)">
				...
				<div class="card-body" style="padding: 0.5rem !important;">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-4">
								<h1>
									Para Llevar<span id="sinterno"></span>
								</h1>
								...
								<input type="hidden" name="hllevaralias" id="hllevaralias" value="0" runat="server"/>
	...
	<div class="modal fade" id="dialoganular" tabindex="-1" role="dialog" aria-labelledby="dialogAnularLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body" id="divanulartexto">
                Esta seguro de eliminar el pedido PARALLEVAR ?
            </div>
            <div class="modal-footer">
...
<script src="../../../plugins/jquery/puntoventa/LlevarPendiente/jquery.listadoweb-3.1.3.js"></script>
<!-- AdminLTE App -->
