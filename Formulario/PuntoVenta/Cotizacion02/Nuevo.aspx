<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Cotizacion02.Nuevo" %>
        ...
        <div class="modal fade" id="dialogDocumento" tabindex="-1" role="dialog" aria-labelledby="dialogDocumentoLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="btn_documento_aceptar" onclick="this.disabled='true';documento_aceptar();"><b>G</b>rabar</button>
                </div>
                </div>
            </div>
        </div>    
...
<script src="../../../plugins/jquery/puntoventa/Cotizacion02/jquery.nuevoweb-2.8.2.js"></script>
