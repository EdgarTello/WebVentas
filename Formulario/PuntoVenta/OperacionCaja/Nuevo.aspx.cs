...
namespace TwoTecnology.WebVentas.Formulario.PuntoVenta.OperacionCaja
{
    public partial class Nuevo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string idcaja = ticket.UserData.Split('|')[27];
            string serie = ticket.UserData.Split('|')[28];


            hidlocal.Value = localcodigo;
            hidcaja.Value = idcaja;
            hserie.Value = serie;
            hmonedacaja.Value = monedacaja;
            hmonedadefault.Value = monedadefault;

            haperturaprint.Value = new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, localcodigo, "aperturaprint").valor;
        }
    }
}