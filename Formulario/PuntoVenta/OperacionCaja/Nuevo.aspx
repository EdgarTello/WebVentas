<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.OperacionCaja.Nuevo" %>
...
<body>
							...
							<div class="container-fluid">
							    <div class="row">
								    <div class="col-6">
										...
										<input type="hidden" name="haperturaprint" id="haperturaprint" runat="server" value="0"/>
								    </div>
								    <div class="col-6">
								    ...
								    <div class="row">
									    <div class="col-lg-2">
										    <label for="cbocaja" class="form-label">Caja</label>
	...
	<script src="../../../plugins/jquery/puntoventa/operacioncaja/jquery.nuevoweb-1.4.9.js"></script>
	<!-- AdminLTE App -->
