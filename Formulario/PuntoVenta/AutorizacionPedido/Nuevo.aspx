<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.AutorizacionPedido.Listado" %>
...
<head runat="server">  
    ...
    <title>Autorización de Pedido</title>	
...
<body>
					...
					<div class="card-body" style="padding: 0.5rem !important;">
						<div class="container-fluid">							
							<div class="row">
								<div class="col-lg-8">
									<h1>
										Autorización: Descuentos, Cambio de Precio
									</h1>
									...
									<input type="hidden" name="hdescuentovalido" id="hdescuentovalido" value="0" runat="server"/>
                            ...
                            <div class="row">
                                <div class="col-lg-2"></div>
                                <div class="col-lg-4">
                                    <span style="font-size:24px">Dscto(I)</span>
                                </div>
                                <div class="col-lg-4" style="display:flex;justify-content:flex-end">
                                    <input type="text" name="descuento_item" id="descuento_item" class="form-control ldatosr" value="0.00" readonly="readonly" runat="server"/>
                                </div>
                                <div class="col-lg-2"></div>
                            </div>               
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-2"></div>
                                <div class="col-lg-4">
                                    <span style="font-size:24px">Dscto(G)</span>
                                </div>
                                <div class="col-lg-4" style="display:flex;justify-content:flex-end">
                                    <input type="text" name="descuento_global" id="descuento_global" class="form-control ldatosr" value="0.00" readonly="readonly" runat="server" />
                                </div>
                                <div class="col-lg-2"></div>
                            </div>               
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4" style="display:flex;justify-content:flex-end">
                                    <input type="text" name="rol_acceso" id="rol_acceso" class="form-control ldatos" readonly="readonly" runat="server"/>
                                </div>
                                <div class="col-lg-2"></div>
                            </div>               
                            <div class="row">
	...
	<script src="../../../plugins/jquery/puntoventa/autorizacionpedido/jquery.nuevoweb-1.1.4.js"></script>
