<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estatico05_Filtro.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Reporte.Estatico05_Filtro" %>
...
<head runat="server">
	...
	<title>Registro de Vales de Consumo</title>
    ...
    <form id="formdocument" runat="server" >
        ...
        <div class="container">
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-4">
                    <div class="row">
                        <span style="color:black">Categoria</span>
                    </div>
                    <div class="row">
                        <asp:DropDownList ID="cbocategoriacliente" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cbocategoriacliente_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col col-lg-4"></div>
            ...
            <div class="row row justify-content-md-center" id="divmesero">
                ...
                <div class="col col-lg-4">
                    ...
                    <div class="row">
                        <asp:DropDownList ID="cbocliente" CssClass="form-control" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col col-lg-4"></div>
    ...
    <script>
        $(function () {
            ...
            $('#btnbuscar').on("click", function (e) {
                ...
                viewestatico('Estatico05.aspx?' +
                    'local=' + $("#cbolocal").val() +
                    '&localdes=' + $("#cbolocal option:selected").text() +
                    '&caja=' + $("#cbocaja").val() +
                    '&cajades=' + $("#cbocaja option:selected").text() +
                    '&categoriacliente=' + $("#cbocategoriacliente").val() +
                    '&categoriaclientedes=' + $("#cbocategoriacliente option:selected").text() +
                    '&cliente=' + $("#cbocliente").val() +
                    '&clientedes=' + $("#cbocliente option:selected").text() +
                    '&mesa=' + $("#cbomesa").val() +
