<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estatico20_Filtro.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Reporte.Estatico20_Filtro" %>
...
<head runat="server">
	...
	<title>Reporte de Paloteo</title>
    ...
    <form id="formdocument" runat="server" >
        ...
        <div class="container">
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-2"  id="divmesero">             
                    <div class="row">
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-2">
                    <div class="row">
                        <span style="color:black">Cambio Precio</span>
                    </div>
                    <div class="row">
                       <asp:DropDownList ID="cbocambioprecio" CssClass="form-control" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col col-lg-2">
                    <div class="row">
                        <span style="color:black">Comandas Anuladas</span>
                    </div>
                    <div class="row">
                       <asp:DropDownList ID="cbocomandaanulada" CssClass="form-control" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col col-lg-4"></div>
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-2">
                    <div class="row">
                        <span style="color:black">Entrega</span>
                    </div>
                    <div class="row">
                       <select id="cboentrega" name="cboentrega" class="form-control">
                ...
                <div class="col col-lg-1">
                    ...
                    <div class="row">
                         <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck1" style="color:black">* Pedidos</label>
                          </div>
                    </div>
                </div>
                <div class="col col-lg-1">
                    ...
                    <div class="row">
                         <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="chktotales"  />
                            <label class="form-check-label" for="exampleCheck2" style="color:black">Totales</label>
                          </div>
                    </div>
                </div>
                <div class="col col-lg-4"></div>
    ...
    <script>
        $(function () {
            ...
            $('#btnbuscar').on("click", function (e) {
                ...
                viewestatico('Estatico20.aspx?' +
                    'local=' + $("#cbolocal").val() +
                    '&localdes=' + $("#cbolocal option:selected").text() +
                    '&caja=' + $("#cbocaja option:selected").val() +
                    ...
                    '&producto=' + $("#cboproducto option:selected").val() +
                    ...
                    '&cambioprecio=' + $("#cbocambioprecio option:selected").text() +
                    '&comandaanulada=' + $("#cbocomandaanulada option:selected").text() +
                    '&entrega=' + $("#cboentrega option:selected").val() +
                    '&pedidoall=' + (($("#chkall").prop("checked")) ? "1" : "0") +
                    '&pedidoatot=' + (($("#chktotales").prop("checked")) ? "1" : "0") +
