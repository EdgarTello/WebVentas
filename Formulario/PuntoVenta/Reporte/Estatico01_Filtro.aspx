<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estatico01_Filtro.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Reporte.Estatico01_Filtro" %>
...
<head runat="server">
	...
	<title>Registro de Ventas Contabilidad</title>
        ...
        <div class="container">
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-2">
                    ...
                    <div class="row">
                        <select id="cbomoneda" class="form-control" runat="server">
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-4">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="chkanulado" name="chkanulado" runat="server" />
                      <label class="form-check-label" for="chkanulado" style="color:black">
                        Se muestra el monto de los documentos anulados.
                      </label>
                    </div>
                </div>
                <div class="col col-lg-4"></div>
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-4">
                    ...
                    <div class="row">
                        <asp:DropDownList ID="cboexportar" CssClass="form-control" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>              
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-2">
                    <input type="button" name="btnbuscar" id="btnbuscar" class="btn btn-primary" value="Buscar / Exportar" />
        ...
        $(function () {
            ...
            $('#btnbuscar').on("click", function (e) {
                ...
                var url='local=' + $("#cbolocal").val() +
                        ...
                        '&moneda=' + $("#cbomoneda option:selected").val() +
                        '&fechaini=' + $("#dfechainicio").val() + ' ' + $("#horainicio").val() +
                        '&fechafin=' + $("#dfechafin").val() + ' ' + $("#horafin").val() +
                        '&montoanulado=' + (($("#chkanulado").is(':checked')) ? '1' : '0') +
                        '&di=' + $("#hdocumentointerno").val()

                if (exportar == '') {
                    viewestatico('Estatico01.aspx?' + url);
                }
                else {
                    window.location.href = 'Exportar01.aspx?exportar=' + exportar + '&' + url;
                }
            });
