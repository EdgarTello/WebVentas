...
{
    public partial class Estatico04_Filtro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cboestado.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                ...
                cboestado.Items.Add(new ListItem { Value = "0", Text = "Por Cobrar" });
                cboestado.Items.Add(new ListItem { Value = "1", Text = "pagado" });
                ...
                using (Repositorio.Cliente obj = new TwoTecnology.Repositorio.Cliente())
                {
                    ...
                    foreach (var item in obj.LoadCredito(empresaruc))
                    {
