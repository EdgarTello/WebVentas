...
{
    public partial class Estatico04 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string estadodes = Request.QueryString["estadodes"];
            ...
            string di)
        {
            ...
            ReportViewer01.LocalReport.ReportPath = Server.MapPath("~/Rpt/Estatico04.rdlc");
            ReportViewer01.LocalReport.DataSources.Clear();

            ReportDataSource datasource = new ReportDataSource("DataSet1",
                new TwoTecnology.Repositorio.Reporte().ReporteCuentasxCobrarFilter(
                ruc,
                local,
                caja,
                cajero,
            ...
            rpMesero.Name = "Estado";
            rpMesero.Values.Add(estadodes);

            ReportParameter rpMesa = new ReportParameter();
            rpMesa.Name = "Cliente";
            rpMesa.Values.Add(clientedes);
