...
{
    public partial class Estatico01_Filtro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cboexportar.Items.Add(new ListItem { Value = "", Text = "[Ninguno]" });
                cboexportar.Items.Add(new ListItem { Value = "1", Text = "StarSoft" });
                cboexportar.Items.Add(new ListItem { Value = "2", Text = "SIGA" });
                cboexportar.Items.Add(new ListItem { Value = "3", Text = "SIRE VENTAS" });
