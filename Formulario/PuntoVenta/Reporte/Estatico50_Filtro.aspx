<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estatico50_Filtro.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Reporte.Estatico50_Filtro" %>
...
<head runat="server">
	...
	<title>Registro de Ventas Motorizado</title>
    ...
    <form id="formdocument" runat="server" >
        ...
        <div class="container">
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-2">
                    <div class="row">
                        <span style="color:black">Motorizado</span>
                    </div>
                    <div class="row">
                        <asp:DropDownList ID="cbomotorizado" CssClass="form-control" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col col-lg-2">
        ...
        $(function () {
            ...
            $('#btnbuscar').on("click", function (e) {
                ...
                var url='local=' + $("#cbolocal").val() +
                        ...
                        '&motorizado=' + $("#cbomotorizado option:selected").text() +
                ...
                viewestatico('Estatico50.aspx?' + url);
