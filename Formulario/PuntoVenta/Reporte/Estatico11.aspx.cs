...
{
    public partial class Estatico11 : System.Web.UI.Page
    {
            ...
            string fechafin)
        {
            ...
            ReportViewer01.LocalReport.ReportPath = Server.MapPath("~/Rpt/Estatico11.rdlc");
            ReportViewer01.LocalReport.DataSources.Clear();

            ReportDataSource datasource = new ReportDataSource("DataSet1",
                new TwoTecnology.Repositorio.Reporte().ReporteOrdenPedidoFilter(
                ruc,
                local,
                cajero,
                fechaini,
