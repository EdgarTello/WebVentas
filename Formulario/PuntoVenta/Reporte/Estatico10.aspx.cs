...
{
    public partial class Estatico10 : System.Web.UI.Page
    {
            ...
            string di)
        {
            ...
            ReportViewer01.LocalReport.ReportPath = Server.MapPath("~/Rpt/Estatico10.rdlc");
            ReportViewer01.LocalReport.DataSources.Clear();

            ReportDataSource datasource = new ReportDataSource("DataSet1",
                new TwoTecnology.Repositorio.Reporte().ReporteVentasFilter(
                ruc,
                local,
                caja,
                cajero,
