...
{
    public partial class Estatico20_Filtro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (!(usuario_acceso == "Administrador" || usuario_acceso == "SuperAdmin" || 
                        usuario_acceso == "Gerencia" || usuario_acceso == "Contador" || 
                ...
                cbocambioprecio.Items.Clear();
                cbocomandaanulada.Items.Clear();

                cbocaja.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                cbocajero.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                cbomesero.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                cbomesa.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                ...
                cbocambioprecio.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                cbocambioprecio.Items.Add(new ListItem { Value = "NO", Text = "NO" });
                cbocambioprecio.Items.Add(new ListItem { Value = "SI", Text = "SI" });

                cbocomandaanulada.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                cbocomandaanulada.Items.Add(new ListItem { Value = "NO", Text = "NO", Selected=true });
                cbocomandaanulada.Items.Add(new ListItem { Value = "SI", Text = "SI" });
        ...
        private void LoadProductos()
        {
            ...
            using (Repositorio.Producto obj = new TwoTecnology.Repositorio.Producto())
            {
                ...
                var lista = obj.LoadObjectByLocalCategoria(empresaruc,  cbocategoria.SelectedValue, "1");

                cboproducto.Items.Add(new ListItem { Value = "", Text = "[Todos]" });

                foreach (var item in lista)
                {
                    cboproducto.Items.Add(new ListItem { Value = item.id, Text = item.nombre });
                }
            }
        }
        ...
        private void LoadCategorias()
        {
            ...
            {
                //cbolocal.SelectedValue
                var lista = obj.Load(empresaruc, "1", "");

                cbocategoria.Items.Add(new ListItem { Value = "", Text = "[Todos]" });

                foreach (var item in lista)
                {
                    cbocategoria.Items.Add(new ListItem { Value = item.id, Text = item.nombre });
                }
            }
        ...
        private void LoadCombos() {
            ...
            using (Repositorio.Empleado obj = new TwoTecnology.Repositorio.Empleado())
            {
                ...
                listaempleado = obj.LoadByAcceso(empresaruc, cbolocal.SelectedValue, "J.Mozo");

                foreach (var item in listaempleado)
                {
                    cbomesero.Items.Add(new ListItem { Value = item.id, Text = item.usuario });
                }

                listaempleado = obj.LoadByAcceso(empresaruc, cbolocal.SelectedValue, "Mesero");
            ...
            {
                listaubicacion = obj.LoadByHijosLocal(empresaruc, cbolocal.SelectedValue);

                cbomesa.Items.Add(new ListItem { Value = "", Text = "[Todos]" });

                foreach (var item in listaubicacion)
                {
                    cbomesa.Items.Add(new ListItem { Value = item.id, Text = item.nombre });
                }
            }
        }
    }
