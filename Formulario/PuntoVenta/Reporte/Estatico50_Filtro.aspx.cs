...
{
    public partial class Estatico50_Filtro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cbocaja.Items.Clear();
                cbomotorizado.Items.Clear();
                cbocierre.Items.Clear();


                cbocaja.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
                cbomotorizado.Items.Add(new ListItem { Value = "", Text = "[Todos]" });
        ...
        private void LoadCombos() {
            ...
            List<Entity.Empleado> lista = new List<Entity.Empleado>();
            ...
            using (Repositorio.Empleado obj = new TwoTecnology.Repositorio.Empleado())
            {
                ...
                lista = obj.LoadByAcceso(empresaruc, cbolocal.SelectedValue, "Motorizado");

                foreach (var item in lista)
                {
                    cbomotorizado.Items.Add(new ListItem { Value = item.id, Text = item.usuario });
                }
