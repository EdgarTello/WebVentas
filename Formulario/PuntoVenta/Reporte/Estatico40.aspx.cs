...
{
    public partial class Estatico40 : System.Web.UI.Page
    {
            ...
            string di)
        {
            ...
            ReportViewer01.LocalReport.ReportPath = Server.MapPath("~/Rpt/Estatico40.rdlc");
            ReportViewer01.LocalReport.DataSources.Clear();

            ReportDataSource datasource = new ReportDataSource("DataSet1",
                new TwoTecnology.Repositorio.Reporte().ReportePropinaFilter(
                ruc,
                local,
                caja,
                cajero,
