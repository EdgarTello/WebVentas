<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estatico04_Filtro.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Reporte.Estatico04_Filtro" %>
            ...
            <div class="row row justify-content-md-center">
                ...
                <div class="col col-lg-4">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="chktodo" name="chktodo" runat="server" />
                      <label class="form-check-label" for="chktodo" style="color:black">
                        Mostrar todos las cuentas x cobrar, sin ultizar los filtros
                      </label>
                    </div>
                </div>
                <div class="col col-lg-4"></div>
        ...
        $(function () {
            ...
            $('#btnbuscar').on("click", function (e) {
                ...
                var url='local=' + $("#cbolocal").val() +
                    ...
                    '&estadodes=' + $("#cboestado option:selected").text() +
                    ...
                    '&todo=' + (($("#chktodo").is(':checked')) ? '1' : '0') +
                    '&di=' + $("#hdocumentointerno").val()

                viewestatico('Estatico04.aspx?' + url);
            });
