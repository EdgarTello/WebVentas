<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.AlmacenSerie.Listado" %>
...
<body>
					...
					<div class="card-body">
						<div class="container-fluid">
							<div class="row">
                                <div class="col-lg-6">
									<h1>
									  Almacén:<span id="salmacennombre"></span> - Series 
									</h1>
	...
	<script src="../../../plugins/jquery/puntoventa/almacenserie/jquery.listadoweb-1.0.0.js"></script>
