<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.AlmacenSerie.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de AlmacenSeriees</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h1>Edición de Serie:<span id="salmacennombre"></span> - <span id="sserienombre"></span>
                                    </h1>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" id="hidalmacen" name="hidalmacen" runat="server" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select  name="cboindicador" id="cboindicador" class="form-control">
                                        <option value="T">T (Electrónico)</option>
                                    </select>
                                </div>
                                <div class="col-lg-3">
...
<script src="../../../plugins/jquery/puntoventa/almacenserie/jquery.nuevoweb-1.0.6.js"></script>
<!-- AdminLTE App -->
