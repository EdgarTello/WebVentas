<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ValesConsumo.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de Vales de Consumo</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="padding: 0.5rem !important;">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <h1>Edición de Vales de Consumo
                                    </h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select id="cboclientecategoria" name="cboclientecategoria" class="form-control input-normal">
									</select>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="monto" id="monto" maxlength="12" class="form-control input-number"  onkeypress="return isNumber(event);" value="0"/>
                                </div>

                                <div class="col-lg-3" id="divcantidad">
                                    <label class="form-label">Cantidad Vales</label>
                                    <input type="text" name="cantidad" id="cantidad" maxlength="12" class="form-control input-number"  onkeypress="return isNumber(event);" value="0"/>
                                </div>
                            </div>
...
<!-- ./wrapper -->
    ...
    <script src="../../../plugins/jquery/puntoventa/valesconsumo/jquery.nuevoweb-2.1.4.js"></script>
    <!-- AdminLTE App -->
