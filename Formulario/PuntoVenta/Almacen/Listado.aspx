<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Almacen.Listado" %>
...
<body>
						...
						<div class="container-fluid">
							<div class="row">
                                <div class="col-6">
									...
									<input type="hidden" name="hAlmacencodigo" id="hAlmacencodigo" value="" runat="server"/>
								</div>
	...
	<script src="../../../plugins/jquery/puntoventa/Almacen/jquery.listadoweb-1.0.8.js"></script>
