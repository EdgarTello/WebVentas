...
namespace TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoPago02
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (pedido.estado == "0")
            {
                if (pedido.autorizacion == "1")
                {
                    ...
                    hvendedor.Value = pedido.vendedor;
                    ...
                    henviarretencion.Value = new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, pedido.idlocal, "enviarretencion").valor;
                    ...
                    hcajarapida.Value = new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, pedido.idlocal, "cajarapida").valor;
                    ...
                    //}
                    //else {
                    //    efectivousdmonto.Value = pedido.total;
                    //    hefectivousdmonto.Value = pedido.total;
                    //}
