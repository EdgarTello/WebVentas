<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.LocalAlmacen.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de LocalAlmacenes</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <h1>Edición de Almacen Local:<span id="slocalnombre"></span></h1>
...
<script src="../../../plugins/jquery/puntoventa/localalmacen/jquery.nuevoweb-1.0.6.js"></script>
<!-- AdminLTE App -->
