<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dinamico02.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Dinamico.Dinamico02" %>
        ...
        <tr>
            ...
            <td>
                ...
                <Fields>
                    ...
                    <dx:PivotGridField Area="RowArea" AreaIndex="3" Caption="Local" FieldName="local"
                        ID="PivotGridFieldLocal" />

                    <dx:PivotGridField Area="RowArea" AreaIndex="4" Caption="Caja" FieldName="caja"
                        ID="PivotGridFieldCaja" />

                    
                    <dx:PivotGridField Area="DataArea" AreaIndex="0" Caption="Cantidad" FieldName="cantidad"
                        ID="PivotGridCantidad" CellFormat-FormatString="N" CellFormat-FormatType="Numeric"/>
                  
                    <dx:PivotGridField Area="DataArea" AreaIndex="1" Caption="Descuento" FieldName="descuento"
                        ID="PivotGridDescuento" CellFormat-FormatString="N" CellFormat-FormatType="Numeric"/>

                   <dx:PivotGridField Area="DataArea" AreaIndex="2" Caption="Importe" FieldName="importe"
                        ID="PivotGridImporte" CellFormat-FormatString="N" CellFormat-FormatType="Numeric"/>

                    <dx:PivotGridField Area="DataArea" AreaIndex="3" Caption="Igv" FieldName="igv"
                        ID="PivotGridIgv" CellFormat-FormatString="N" CellFormat-FormatType="Numeric"/>

                    <dx:PivotGridField Area="DataArea" AreaIndex="4" Caption="Rc" FieldName="rc"
                        ID="PivotGridRc" CellFormat-FormatString="N" CellFormat-FormatType="Numeric"/>

                    <dx:PivotGridField Area="DataArea" AreaIndex="5" Caption="Total" FieldName="total"
                        ID="fieldtotal" CellFormat-FormatString="N" CellFormat-FormatType="Numeric"/>
                    ...
                    <dx:PivotGridField Area="FilterArea" AreaIndex="3" Caption="Hora" FieldName="hora"
                        ID="PivotGridFieldHora" />
                  
                   <dx:PivotGridField Area="FilterArea" AreaIndex="4" Caption="Documento" FieldName="documento"
                    ...
                    <dx:PivotGridField Area="FilterArea" AreaIndex="7" Caption="CliTipo" FieldName="clientetipo"
                        ID="PivotGridFieldClienteTipo" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="7" Caption="CliCategoria" FieldName="clientecategoria"
                        ID="PivotGridFieldClienteCategoria" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="8" Caption="CliNombre" FieldName="clientenombre"
                        ID="PivotGridFieldClienteNombre" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="9" Caption="CliDistrito" FieldName="clientedistrito"
                        ID="PivotGridFieldClienteDistrito" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="10" Caption="Cajero" FieldName="cajero"
                        ID="PivotGridFieldCajero" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="11" Caption="Mesero" FieldName="mesero"
                        ID="PivotGridFieldMesero" />
