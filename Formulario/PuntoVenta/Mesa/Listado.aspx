<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Mesa.Listado" %>
...
<body>
    <form id="formulario" name="formulario" asp-antiforgery="false"  runat="server" >
    ...
    <script src="../../../plugins/jquery/puntoventa/mesa/jquery.listadoweb-3.0.2.js"></script>
