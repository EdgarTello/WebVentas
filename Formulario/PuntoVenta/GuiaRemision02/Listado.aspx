<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.GuiaRemision02.Listado" %>
...
<body>
						...
						<div class="container-fluid">
							...
							<div class="row">
								<div class="col-lg-3">
									<div class="row">
										<div class="col-lg-6">
											<input id="fechainicio" name="fechainicio" class="form-control input-normal" readonly="readonly"/>
										</div>
										<div class="col-lg-6">
											<input id="fechafin" name="fechafin" class="form-control input-normal" readonly="readonly"/>
										</div>
									</div>
								</div>
								<div class="col-lg-1">
								...
								<div class="col-lg-1">
									<select id="cboanulado" name="cboanulado" class="form-control input-normal">
										<option value="" selected="selected">[Anulado]</option>
								...
								<div class="col-lg-2">
									<select id="cbotipo" name="cbotipo" class="form-control input-normal">
								...
								<div class="col-lg-1">	
									<button type="button" class="float-right" id="btnpedido">
										<i class="fas fa-file"></i>Pedido
									</button>
								</div>
	...
	<script src="../../../plugins/jquery/puntoventa/GuiaRemision02/jquery.listadoweb-1.7.4.js"></script>
