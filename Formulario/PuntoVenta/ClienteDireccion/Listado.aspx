<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ClienteDireccion.Listado" %>
								...
								<div class="d-flex flex-row justify-content-end p-1">
									<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
										<div class="btn-group mr-2" role="group" aria-label="First group">
											<button type="button" class="btn btn-success" id="btnnuevo" title="Nuevo">
												<i class="fas fa-file"></i>
											</button>
										</div>
										<div class="btn-group mr-2" role="group" aria-label="Second group">											
											<button type="button" class="btn btn-secondary" id="btncancelar" title="Cancelar">
...
<script src="../../../plugins/jquery/puntoventa/ClienteDireccion/jquery.listadoweb-3.1.4.js"></script>
<!-- AdminLTE App -->
