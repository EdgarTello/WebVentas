...
namespace TwoTecnology.WebVentas.Formulario.PuntoVenta.ClienteDireccion
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "2")
            {
                ...
                if (!blnerror)
                {
                    ...
                    using (Repositorio.ClienteDireccion obj = new TwoTecnology.Repositorio.ClienteDireccion())
                    {
                        if (id == "0")
                        {
                            obj.Agregar(idcliente, departamento, provincia, distrito, 
            ...
            if (Request.QueryString["ope"] == "2_1")
            {
                ...
                if (!blnerror)
                {
                    ...
                    using (Repositorio.ClienteDireccion obj = new TwoTecnology.Repositorio.ClienteDireccion())
                    {
                        respuesta=obj.Agregar(idcliente, departamento, provincia, distrito, direccion, ubigeo);
                    }
                }
            }
