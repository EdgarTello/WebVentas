<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.TipoGasto.Listado" %>
...
<head runat="server">
    ...
    <title>Edición de TipoGasto</title>
                                ...
                                <div class="col-6">
							        <div class="d-flex flex-row justify-content-end p-1">
								        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
									        ...
									        <div class="btn-group mr-2" role="group" aria-label="First group">
										        <button type="button" class="btn btn-secondary" id="btnbuscar" title="Refrescar">
...
<script src="../../../plugins/jquery/puntoventa/TipoGasto/jquery.listadoweb-1.0.5.js"></script>
<!-- AdminLTE App -->
