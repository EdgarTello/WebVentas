<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.GuiaCliente02.Listado" %>
...
<body>
			...
			<div class="card">
				<div class="card-body">
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-lg-4">
								<input type="text" class="form-control float-right" id="busqueda" name="busqueda" placeholder="Nombre, Documento, Telefono" required="required" />
							</div>
							<div class="col-lg-8">
								<button type="button" class="float-left" id="btnbuscar">
	...
	<script src="../../../plugins/jquery/puntoventa/GuiaCliente02/jquery.listadoweb-4.0.4.js"></script>
	<!-- AdminLTE App -->
