<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vista.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.GuiaRemision23.Vista" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="padding:0.25rem !important">
                        <div class="container-fluid">
                            <embed id="embedpdf" name="embedpdf" src="../../../Img/loading.gif" frameborder="0" width="250" height="200" type="application/pdf"/>
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
...
<script src="../../../plugins/jquery/puntoventa/guiaremision23/jquery.vistaweb-1.8.6.js"></script>
<!-- AdminLTE App -->
