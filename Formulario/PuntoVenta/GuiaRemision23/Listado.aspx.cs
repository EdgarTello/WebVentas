        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    hguiaauditor.Value = new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, localcodigo, "guiaauditor").valor;
                    hguiavalidador.Value = new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, localcodigo, "guiavalidador").valor;
