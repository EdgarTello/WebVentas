    ...
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                Metodos.ValidateAntiXsrfToken("DocumentoList");


                if (idlocal.IsNumeric() && !idcaja.IsInyection() && 
                    !estado.IsInyection() && !anulado.IsInyection() &&
                    !di.IsInyection() && !tipodocumento.IsInyection() &&
                    ...
                    !fechainicio.IsInyection() && !fechafin.IsInyection())
                {
                    using (Repositorio.Pedido obj = new TwoTecnology.Repositorio.Pedido())
                    {
                        respuesta = obj.LoadByCajaConCierreFilter(
                            idlocal,
                            ((usuario_acceso == "Cajero" || usuario_acceso == "Administrador" || usuario_acceso == "SuperAdmin") ? "" : idcaja),
