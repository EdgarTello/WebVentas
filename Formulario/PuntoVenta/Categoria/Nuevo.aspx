<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Categoria.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de Categoría</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="descripcion" class="form-control" maxlength="50" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="color" id="fondocolor" class="form-control" maxlength="3" />
                                    </div>
                                </div>

                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label class="form-label">Fuente Color</label>
                                        <input type="color" id="fuentecolor" class="form-control" maxlength="3" />
                                    </div>
                                </div>
...
<script src="../../../plugins/jquery/puntoventa/Categoria/jquery.nuevoweb-1.0.0.js"></script>
<!-- AdminLTE App -->
