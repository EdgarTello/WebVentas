<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoNC03.Nuevo" %>
...
<body>
    <form id="formulario" name="formulario" runat="server" >
            ...
            <section class="content-header" style="padding: 5px .5rem"> 
                <div class="row">
                    <div class="col-4">
                        ...
                        <label>
                            <select  name="cbomotivo_referencia" id="cbomotivo_referencia" class="form-control" style="width:200px;border-color:red" >                              
                            </select>
                        </label>
                    </div>
                    <div class="col-4">
                        <div class="d-flex flex-row justify-content-end p-1">
						    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                ...
                                <div class="btn-group mr-2" role="group" aria-label="First group">
									<button type="button" class="btn btn-outline-primary btn-bold" onclick="pago();" title="Forma de Pago">
                                ...
                                <div class="btn-group mr-2" role="group" aria-label="For group" id="lcontingencia" style="visibility:hidden">
        ...
        <div class="modal" id="dialog_descuento_global" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                Esta seguro de generar descuento global?
                            </div>
                        </div>
                        <div class="row">
                            <br />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                Motivo o sustento por el cual se emitirá la Nota de Crédito
                            </div>
                        </div>          
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="text" name="texto_descuento_global" id="texto_descuento_global" maxlength="100" class="form-control" />
                            </div>
                        </div>      
                         <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="text" name="monto_descuento_global" id="monto_descuento_global" class="form-control input-number" value="0.00"  onkeypress="return isNumberKey(event)"/>
                            </div>
                        </div>    
                    </div>
                   <div class="modal-footer">
                       <input type="button" class="btn btn-secondary" data-dismiss="modal" value="Cancelar" title="Cancelar"  />
                       <input type="button" id="btngrabar_descuento_global" class="btn btn-success" value="Confirmar" title="Confirmar"   />
        ...
        <div class="modal" id="dialopago" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" style="color:black">Punto de Venta</h3>
					...
					<div class="modal-body">                        
                        ...
                        <div class="row" id="divcredito001" name="divcredito001" style="display:none">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="monto001" id="monto001" maxlength="12" class="form-control input-number" value="" placeholder="0.00" onkeypress="return isNumberKey(event);" />
                            </div>
                        </div>
                        ...
                        <div class="row" id="divcredito002" name="divcredito002" style="display:none">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="monto002" id="monto002" maxlength="12" class="form-control input-number" value="" placeholder="0.00" onkeypress="return isNumberKey(event);" />
                            </div>
                        </div>
                        ...
                        <div class="row" id="divcredito003" name="divcredito003" style="display:none">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="monto003" id="monto003" maxlength="12" class="form-control input-number" value="" placeholder="0.00" onkeypress="return isNumberKey(event);" />
                            </div>
                        </div>
                   ...
                   <div class="modal-footer">
                       <input type="button" class="btn btn-secondary" data-dismiss="modal" value="Cancelar" title="Cancelar"  />
                       <input type="button" id="btnpago" class="btn btn-success" onclick="grabar_pago();" value="Confirmar" title="Confirmar"   />
...
<script src="../../../plugins/jquery/puntoventa/PuntoNC03/jquery.nuevoweb-3.0.2.js"></script>
<!-- AdminLTE App -->
