<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.DeliveryDireccion.Listado" %>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-6">
								...
								<input type="hidden" id="hidentrega" name="hidentrega" runat="server" />
								<input type="hidden" id="hdireccion" name="hdireccion" runat="server" />
								<input type="hidden" id="hreferencia" name="hreferencia" runat="server" />
								<input type="hidden" id="htelefonofijo" name="htelefonofijo" runat="server" />
								<input type="hidden" id="htelefonocelular" name="htelefonocelular" runat="server" />
							</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
                    ...
                    <div class="modal-footer">
                       ...
                       <input type="button" id="btngrabar" class="btn btn-success" onclick="this.disabled='true';grabar();" value="Confirmar" title="Generar"   />                       
                    </div>
                </div>
            </div>
        </div>
...
<script src="../../../plugins/jquery/puntoventa/deliverydireccion/jquery.listadoweb-4.0.3.js"></script>
<!-- AdminLTE App -->
