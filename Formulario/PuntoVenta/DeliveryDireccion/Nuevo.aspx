<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.DeliveryDireccion.Nuevo" %>
...
<body>
                        ...
                        <div class="container-fluid">
							...
							<div class="row">
                                ...
                                <div class="col-lg-3">
									...
									<input name="nombre" id="nombre" class="form-control form-control-sm" maxlength="50" placeholder="MÁXIMO 50 CARACTERES" required="required" />
								</div>
								...
								<div class="col-lg-3">
									...
									<input type="text" name="ubigeo" id="ubigeo" maxlength="6" class="form-control" readonly="readonly"/>
								</div>
	...
	<script src="../../../plugins/jquery/puntoventa/deliverydireccion/jquery.nuevoweb-4.0.3.js"></script>
	<!-- AdminLTE App -->
