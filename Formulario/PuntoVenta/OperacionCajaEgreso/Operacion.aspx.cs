    ...
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "0")
            {
                ...
                using (Repositorio.CajaOperacionEgreso obj = new TwoTecnology.Repositorio.CajaOperacionEgreso())
                {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                using (Repositorio.CajaOperacionEgreso obj = new TwoTecnology.Repositorio.CajaOperacionEgreso())
                {
                    respuesta = obj.Load(id).Serialize();
                }
            }
            ...
            {
                string id = Request.QueryString["id"];
                string idcajaoperacion = Request.QueryString["idcajaoperacion"];
                ...
                using (Repositorio.CajaOperacionEgreso obj = new TwoTecnology.Repositorio.CajaOperacionEgreso())
                {
                    if (id == "0")
                    {   
                        obj.Agregar(idcajaoperacion, idoperacion, moneda, monto, descripcion);
                    }
                    else
                    {
                        obj.Editar(id, idcajaoperacion, idoperacion, moneda, monto, descripcion);
                    }
                }
            }
