<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoVenta21.Listado" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="../../../Content/style_custom_v21.css" />
</head>
<body>
						...
						<div class="container-fluid">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									...
									<button type="button" class="float-right" id="btnnc">
	...
	<script src="../../../plugins/jquery/puntoventa/puntoventa21/jquery.listadoweb-3.0.0.js"></script>
