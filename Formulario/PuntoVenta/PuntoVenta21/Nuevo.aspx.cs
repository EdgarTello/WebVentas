...
namespace TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoVenta21
{
    public partial class Nuevo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            hscanerproducto.Value = jsonconfig.Configurate("scanerproducto");//new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, localcodigo, "scanerproducto").valor;
            string perfilcambioprecio = jsonconfig.Configurate("cambioprecio");//new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, localcodigo, "cambioprecio").valor;
