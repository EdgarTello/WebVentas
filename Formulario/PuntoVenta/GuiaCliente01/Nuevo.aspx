<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.GuiaCliente01.Nuevo" %>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Esta seguro de generar el GuiaCliente01  <span id="scaja"></span></p>
                        <p>Desea proceder?</p>
                        <p class="debug-url"></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                        <a class="btn btn-success btn-ok" onclick="GuiaCliente01grabar();">Aceptar</a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="../../../plugins/jquery/puntoventa/GuiaCliente01/jquery.nuevoweb-4.0.4.js"></script>
<!-- AdminLTE App -->
