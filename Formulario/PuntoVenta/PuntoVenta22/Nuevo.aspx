<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoVenta22.Nuevo" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="padding:0.5rem">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-5 border-cat">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <input type="text" id="qproducto" name="qproducto" class="form"  placeholder="Producto" onkeypress="return productoenter(event);"/>
                                         </div>
					...
					<div class="modal-body">
                       ...
                       <div class="row">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_item_submonto" id="descuento_item_submonto" class="form-control" style="font-size:28px; width:140px" readonly="readonly"/>
                            </div>
                        </div>        
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_item_monto" id="descuento_item_monto" class="form-control"  maxlength="7"  placeholder="0.00" onkeypress="return isNumberKey(event)"  style="font-size:28px;width:140px" />
                            </div>
                        </div>
                        <div class="row">
                           <div class="col-sm-4 col-md-4 col-lg-4 col-centered">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_item_porcentaje" id="descuento_item_porcentaje" class="form-control"  maxlength="7" placeholder="0.00" onkeypress="return isNumberKey(event)"  style="font-size:28px;width:140px" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4" style="display:flex;justify-content:flex-end">
                                <input type="number" name="descuento_item_total" id="descuento_item_total" class="form-control" value="0" style="font-size:28px;width:140px"  readonly="readonly"/>
                            </div>
                        </div>
                    </div>
					<div class="modal-footer">                     
				...
				<div class="modal-content">
					...
					<div class="modal-body">                        
                       <div class="row">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_global_submonto" id="descuento_global_submonto" class="form-control" style="font-size:28px; width:140px" readonly="readonly"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_global_monto" id="descuento_global_monto" class="form-control" maxlength="7" placeholder="0.00" onkeypress="return isNumberKey(event)" style="font-size:28px;width:140px" />
                            </div>
                       ...
                       <div class="row">
                           <div class="col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_global_porcentaje" id="descuento_global_porcentaje" class="form-control" maxlength="7" placeholder="0.00" onkeypress="return isNumberKey(event)" style="font-size:28px;width:140px" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4" style="display:flex;justify-content:flex-end">
                                <input type="text" name="descuento_global_total" id="descuento_global_total" class="form-control" maxlength="7" placeholder="0.00" onkeypress="return isNumberKey(event)" style="font-size:28px;width:140px" readonly="readonly" />
                            </div>
...
<script src="../../../plugins/jquery/puntoventa/PuntoVenta22/jquery.nuevoweb-3.0.0.js"></script>
<!-- AdminLTE App -->
