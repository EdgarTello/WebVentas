<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.AnulacionDocumento.Nuevo" %>
...
<body>
					...
					<div class="card-body" style="padding: 0.5rem !important;">
						<div class="container-fluid">
							<div class="row">
                                <div class="col-lg-8">
									<h1>
										Anulación Documento - Usuario Autorizador
									</h1>
								...
								<div class="col-lg-4">
									<asp:Button ID="btnAutorizar" runat="server" CssClass="btndefault float-right" OnClick="btnAutorizar_Click" Text="Autorizar" OnClientClick="this.disabled='true';"  UseSubmitBehavior="false"/>
	...
	<script src="../../../plugins/jquery/puntoventa/anulaciondocumento/jquery.nuevoweb-1.1.3.js"></script>
