<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.LocalCaja.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de LocalCajaes</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <h1>Edición de Caja Local:<span id="slocalnombre"></span> - <span id="subicacionnombre"></span>
                                    </h1>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select id="cboserie" name="cboserie" class="form-control"></select> 
                                </div>
...
<script src="../../../plugins/jquery/puntoventa/localcaja/jquery.nuevoweb-1.0.5.js"></script>
<!-- AdminLTE App -->
