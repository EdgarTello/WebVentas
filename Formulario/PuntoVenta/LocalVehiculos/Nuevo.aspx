<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.LocalVehiculos.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de LocalVehiculos</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <h1>Edición de Trasnporte Local:<span id="slocalnombre"></span> - <span id="sareanombre"></span>
                                    </h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="placa" id="placa"  maxlength="8" class="form-control" onkeypress="return isAlphanumericKey(event);"  required="required"/>
                                </div>
                                
                                <div class="col-lg-3">
                                    <label class="form-label">Marca</label>
                                    <input type="text" name="marca" id="marca"  maxlength="50" class="form-control" />
                                </div>
...
<script src="../../../plugins/jquery/puntoventa/localvehiculos/jquery.nuevoweb-1.0.8.js"></script>
<!-- AdminLTE App -->
