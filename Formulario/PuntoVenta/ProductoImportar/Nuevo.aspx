<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ProductoImportar.Nuevo" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
									...
									<div class="d-flex flex-row justify-content-end p-1">
										<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                            <div class="btn-group mr-2" role="group" aria-label="First group">
												<button type="button" class="btn btn-warning" id="btngrabar" title="Procesar" disabled="disabled">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <label for="cboimpuesto">Almacen</label>
                                    <asp:DropDownList ID="almacen" CssClass="form-control" runat="server"></asp:DropDownList>
                                </div>
                                <div class="col-2">
                                    <label class="form-label">Separador</label>
                                    <input type="text" name="separador" id="separador" value=";"  class="form-control" style="width:40px"/>
                                </div>

                                <div class="col-2">
                                    <label class="form-label">Ajuste</label>
                                    <br />
                                    <input type="checkbox" id="ajuste" name="ajuste" />
                                </div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
                       Esta seguro importar los productos?
                    </div>
                   <div class="modal-footer">
                       <input type="button" class="btn btn-secondary" data-dismiss="modal" value="Cancelar" title="Cancelar"  />
                       <input type="button" class="btn btn-success" onclick="importar_producto();" value="Procesar" title="Procesar"   />
...
<script src="../../../plugins/jquery/puntoventa/productoimportar/jquery.nuevoweb-1.1.4.js"></script>
<!-- AdminLTE App -->
