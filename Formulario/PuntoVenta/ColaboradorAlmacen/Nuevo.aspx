<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.ColaboradorAlmacen.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de ColaboradorAlmacenes</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h1>Edición de Empleado Almacen:<span id="sempleadonombre"></span>
                                    </h1>
...
<script src="../../../plugins/jquery/puntoventa/colaboradoralmacen/jquery.nuevoweb-1.0.6.js"></script>
<!-- AdminLTE App -->
