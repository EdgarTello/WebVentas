<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoVenta01.Nuevo" %>
...
<body>
    <form id="formulario" name="formulario" runat="server" >
        ...
        <div class="row margin-top-05">
            ...
            <div class="col-sm-1">
                ...
                <input type="text" name="idcliente" id="idcliente" style="width:100px" maxlength="11" value="" class="form-control" placeholder="RUC/DNI" />
                ...
                <input type="hidden" name="hidlocal" id="hidlocal" runat="server" value=""/>
            </div>
            <div class="col-sm-2">
        ...
        <div class="row margin-top-05" id="divnc">
              ...
              <div class="col-sm-2">
                <input type="text" name="dreferencia" id="dreferencia" style="width:120px;border-color:red" maxlength="13" class="form-control" placeholder="Referencia"  />
              </div>
              <div class="col-sm-2"> 
    ...
    <script src="../../../plugins/jquery/puntoventa/puntoventa01/jquery.nuevoweb-3.0.0.js"></script>
    <!-- AdminLTE App -->
