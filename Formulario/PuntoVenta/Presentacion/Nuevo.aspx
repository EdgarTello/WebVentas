<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Presentacion.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de Presentación</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="descripcion" class="form-control" maxlength="50" required="required" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="codigosunat" class="form-control" maxlength="3" required="required" />
                                    </div>
                                </div>
...
<script src="../../../plugins/jquery/puntoventa/presentacion/jquery.nuevoweb-1.0.1.js"></script>
<!-- AdminLTE App -->
