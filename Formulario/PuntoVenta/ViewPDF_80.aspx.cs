...
{
    public partial class ViewPDF_80 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (webservice == "0")
            {
                ...
                {
                    var pdf = objeto.GenerarPDF_Documento(id, "80");
            ...
            else
            {
                ...
                using (servicioImpresionPedido.DocumentoPedidoClient doc = new servicioImpresionPedido.DocumentoPedidoClient())
                {
                    ...
                    {
                        documento = doc.ObtenerPdf80(ruc, tipo, string.Format("{0}{1}", indicador, serie), correlativo);
                    }
