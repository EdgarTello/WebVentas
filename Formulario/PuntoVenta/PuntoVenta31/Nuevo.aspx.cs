...
namespace TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoVenta31
{
    public partial class Nuevo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            himprimedi.Value = new TwoTecnology.Repositorio.Configuracion().LoadObject(ruc, localcodigo, "imprimedi").valor ?? "0";
            ...
            if (hid.Value != "0")
            {
                ...
                lblentrega.Text = string.Format("{0}:{1}", pedido.entrega, pedido.cliente.Left(20));
                lblempleado.Text = string.Format("{0}", pedido.empleado);
