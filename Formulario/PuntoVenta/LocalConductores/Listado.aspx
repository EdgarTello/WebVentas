<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.LocalConductores.Listado" %>
...
<body>
					...
					<div class="card-body">
						<div class="container-fluid">
							<div class="row">
                                <div class="col-6">
									<h1>
									  Local:<span id="slocalnombre"></span> - Conductor 
									</h1>
							...
							<div class="row">
								<div class="col-lg-4">
									<input id="documento" name="documento" class="form-control input-normal" maxlength="20" placeholder="Dni o Licencia"/>
								</div>
								<div class="col-lg-4">
	...
	<script src="../../../plugins/jquery/puntoventa/localconductores/jquery.listadoweb-1.0.8.js"></script>
	<!-- AdminLTE App -->
