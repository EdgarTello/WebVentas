<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.AnulacionComanda.Nuevo" %>
...
<body>
					...
					<div class="card-body" style="padding: 0.5rem !important;">
						<div class="container-fluid">
							<div class="row">
                                <div class="col-lg-12">
									<h1>
										Anulación Item - Usuario Autorizador
									</h1>
							...
							<div class="row">
								<div class="col-lg-12">
									<asp:Button ID="btnAutorizar" runat="server" CssClass="btndefault float-right btndefault" OnClick="btnAutorizar_Click" Text="Autorizar" OnClientClick="this.disabled='true';"  UseSubmitBehavior="false"/>

									<button type="button" class="btndefault float-right" id="btnretornar">
										<i class="fas fa-back"></i>Retornar
									</button>
	...
	<script src="../../../plugins/jquery/puntoventa/anulacioncomanda/jquery.nuevoweb-1.1.3.js"></script>
