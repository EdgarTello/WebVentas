        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                using (Repositorio.Pedido obj = new TwoTecnology.Repositorio.Pedido())
                {
                    ...
                    respuesta = obj.AgregarPersonas(idubicacion, ninos, adultos,
                        ancianos, hombres, mujeres, personas, 
                        ((usuario_acceso != "Mesero") ? empleado : ""), 
                        idlocal,
                        entrega, pagado, alias, idcaja, caja, serie, impresora,
                        ((usuario_acceso == "Mesero" || usuario_acceso == "J.Mozo") ? empleado : ""),
                        "","","00","00","",
                        ruc);

                    obj.ActualizaAliasUbicacion(respuesta, idubicacion);
                }
            }
            ...
            if (Request.QueryString["ope"] == "5")
            {
                ...
                using (Repositorio.Pedido obj = new TwoTecnology.Repositorio.Pedido())
                {
                    ...
                    respuesta = obj.LoadPedidoActivo(idubicacion,
                        entrega,
                        ruc);
                }
            }
