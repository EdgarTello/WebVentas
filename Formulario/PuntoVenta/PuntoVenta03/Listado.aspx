<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoVenta03.Listado" %>
...
<body>
    <form id="formulario" name="formulario" runat="server" >
							...
							<div class="row">
								...
								<div class="col-lg-1">
									<select id="cboanulado" name="cboanulado" class="form-control input-normal" >
										...
										<option value="1">ANU(CLIENTE)</option>
										<option value="-1">ANU(SISTEMA)</option>
									</select>
								</div>
									...
									<div class="d-flex flex-row justify-content-end p-1">
										<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
											<div class="btn-group mr-2" role="group" aria-label="First group">												
												<button type="button" class="btn btn-success" id="btnexportar" title="Exportar Excel">
		...
		<div class="modal" id="dialogregenerar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" style="color:black">Regenerar Pedido</h3>
                   ...
                   <div class="modal-footer">
                       ...
                       <input type="button" class="btn btn-success" onclick="actualizarregenerar();" value="Grabar" title="Grabar"   />
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
                   ...
                   <div class="modal-footer">
                       ...
                       <input type="button" id="btnactualizarnc" class="btn btn-success" onclick="this.disabled='true';actualizar_nc();" value="Confirmar" title="Impresión"   />
	...
	<script src="../../../plugins/jquery/puntoventa/puntoventa03/jquery.listadoweb-3.0.0.js"></script>
