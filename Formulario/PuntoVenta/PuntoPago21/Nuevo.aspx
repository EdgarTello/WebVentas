<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.PuntoPago21.Nuevo" %>
...
<body>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <input type="text" name="numerodocumento" id="numerodocumento" runat="server"  class="form-control"  />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
    ...
    <script src="../../../plugins/jquery/puntoventa/PuntoPago21/jquery.nuevoweb-3.0.0.js"></script>
    <!-- AdminLTE App -->
