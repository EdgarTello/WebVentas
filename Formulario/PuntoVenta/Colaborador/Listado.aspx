<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Colaborador.Listado" %>
...
<body id="bdocumento">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("ColaboradorList") %>" />
						    ...
						    <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="input-group input-group mb-3">
                                        <input type="text" id="busqueda" name="busqueda" class="form-control input-normal enter" autocomplete="on" placeholder="Nombre o Apellido" />
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="d-flex flex-row justify-content-end p-1">
    ...
    <script src="../../../plugins/jquery/puntoventa/colaborador/jquery.listadoweb-1.1.6.js"></script>
