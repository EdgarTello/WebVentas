<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Cliente.Listado" %>
...
<body id="bdocumento">
                    ...
                    <div class="card-body" style="padding: 0.5rem !important;">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-6">
                                    <h1>Clientes</h1>
                                    <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("ClienteList") %>" />
                                ...
                                <div class="col-6">
									<div class="d-flex flex-row justify-content-end p-1">
										<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                            ...
                                            <div class="btn-group mr-2" role="group" aria-label="First group" id="divretornar" style="display:none">
							...
							<div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group input-group mb-3">
                                        <input type="text" id="busqueda" name="busqueda" class="form-control enter"  autocomplete="on"  placeholder="Nombre, Documento, Telefono" required="required" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
    ...
    <script src="../../../plugins/jquery/puntoventa/cliente/jquery.listadoweb-3.1.6.js"></script>
    <!-- AdminLTE App -->
</body>
</html>