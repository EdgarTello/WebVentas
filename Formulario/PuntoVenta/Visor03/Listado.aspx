<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Visor03.Listado" %>
            ...
            <section class="content-header" style="padding: 5px .5rem">
                ...
                <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left:0px !important">
                    ...
                    <ul class="navbar-nav ml-auto">
                      <!-- Navbar Search -->
                      <li class="nav-item">
                        <a class="nav-link" style="text-decoration:underline !important;color: blue !important;" href="../Visor04/Listado.aspx">Historial</a>    
                      </li>
...
<script src="../../../plugins/jquery/puntoventa/Visor03/jquery.listadoweb-1.3.7.js"></script>
