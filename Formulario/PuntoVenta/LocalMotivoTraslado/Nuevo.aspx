<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.LocalMotivoTraslado.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de LocalMotivoTrasladoes</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h1>Edición de Motivo Traslado Local:<span id="slocalnombre"></span></h1>
...
<script src="../../../plugins/jquery/puntoventa/localmotivotraslado/jquery.nuevoweb-1.0.6.js"></script>
<!-- AdminLTE App -->
