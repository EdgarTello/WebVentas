<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Usuario.Listado" %>
							...
							<div class="row">
                                <div class="col-lg-4">
                                    <div class="input-group input-group mb-3">
                                        <input type="text" class="form-control float-right" id="busqueda" name="busqueda" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Nombre Apellidos" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
    ...
    <script src="../../../plugins/jquery/puntoventa/usuario/jquery.listadoweb-1.1.5.js"></script>
