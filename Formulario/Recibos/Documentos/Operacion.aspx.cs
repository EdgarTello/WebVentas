    ...
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                if (usuario_acceso == "Administrador" || usuario_acceso == "SuperAdmin" || usuario_acceso == "Empleado")
                {

                    
                    using (TwoTecnology.Repositorio.Recibos obj = new TwoTecnology.Repositorio.Recibos())
                    {
                        respuesta = obj.Load(
                            ruc,
                            idlocal,
                            ((usuario_acceso == "SuperAdmin" || usuario_acceso == "Admin") ? "" : usuario_codigo),
                            fechainicio,
                            fechafin,
                            estado).Serialize();
                    }
            ...
            if (Request.QueryString["ope"] == "001" && (usuario_acceso == "Administrador" || usuario_acceso == "SuperAdmin"))
            {
