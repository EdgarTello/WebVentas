        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (IsValid)
            {
                if (hpassword.Value.Length > 3)
                {
                    ...
                    string pathmesapartes = string.Format(@"{0}", 
                        ConfigurationManager.AppSettings["pathmesapartes"]);

                    string pathrecibos=string.Format(@"{0}",
                        ConfigurationManager.AppSettings["pathrecibos"]);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                FormsAuthenticationTicket ticket = new FormsAuthenticationTicket(1,
                                    ...
                                    usu.jefatura + "|" +   //36
                                    usu.idjefatura + "|" +   //37
                                    usu.jefaturanombre + "|"  +  //38
                                    usu.personalacargo + "|" +  //39
