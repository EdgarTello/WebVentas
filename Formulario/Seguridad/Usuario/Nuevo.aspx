<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.Seguridad.Usuario.Nuevo" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
                    ...
                    <div class="card-header p-4 border-bottom bg-body">
                        <div class="row g-3 justify-content-between align-items-center">
                            <div class="col-12 col-md">
                                <h4 class="text-body mb-0" data-anchor="data-anchor">Empleado</h4>
                                ...
                                <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("UsuarioNew") %>" />
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="comision" type="text" maxlength="2" onkeypress="return isNumber(event);"/>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label" for="cookie">Cookie</label>
                                <input class="form-control" id="cookie" type="text" maxlength="100" />
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check mb-0">
                                    <input class="form-check-input" id="chkcookie" type="checkbox" />
                                    <label class="form-check-label mb-0" for="chkcookie">Generar cookie</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="../../../plugins/jquery/seguridad/usuario/jquery.nuevoweb-1.2.2.js"></script>
    </body>
