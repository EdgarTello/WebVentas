<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.Seguridad.Permiso.Nuevo" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
                ...
                <div class="card shadow-none border my-4" data-component-card="data-component-card">
                    <div class="card-header p-4 border-bottom bg-body">
                        <div class="row g-3 justify-content-between align-items-center">
                            <div class="col-6 col-md">
                                <h4 class="text-body mb-0" data-anchor="data-anchor">Rol</h4>
                                ...
                                <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("PermisoNew") %>" />
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="p-4">
                            ...
                            <div class="mb-3">                            
                                <label class="form-label" for="paginadefecto">Pagina Defecto</label>
                                <input class="form-control" id="paginadefecto" type="text" maxlength="100" required="required"/>
                                <div class="invalid-feedback"></div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="paginaredireccion">Pagina Redireccion</label>
                                <input class="form-control" id="paginaredireccion" type="text" maxlength="100" required="required" value="../Frame/Index.aspx"/>
                                <div class="invalid-feedback"></div>
                            </div>
        ...
        <script src="../../../plugins/jquery/seguridad/permiso/jquery.nuevoweb-1.2.0.js"></script>
    </body>
