<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.Seguridad.Permiso.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
            ...
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-center">
                    <div class="col-12 col-md">
                        <h4 class="text-body mb-0" data-anchor="data-anchor">Listado de Permisos</h4>
                        ...
                        <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("PermisoList") %>" />
                    </div>
                    <div class="col col-md-auto">                
                        <nav class="nav justify-content-end doc-tab-nav align-items-center" role="tablist">
                            <div class="row">
                                <div class="col">
                                    <select id="cborol" name="cborol" class="form-select me-1 mb-1"></select>
                                </div>
                                <div class="col">
                                    <button id="btnagregar" class="btn btn-primary me-1 mb-1" type="button"><i class="fa-solid fa-plus me-2"></i>Agregar</button>
                                </div>
                            </div>
                        </nav>
                    </div>
                            ...
                            <table id="tbldetalle" class="table table-sm fs-9 mb-0 overflow-hidden">
                                <thead class="text-body bg-body-highlight">
                                    <tr>
                                        ...
                                        <th class="sort text-end align-middle pe-0 ps-4" scope="col" data-sort="modulo">MODULO</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="opcion">OPCION</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="ruta">RUTA</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">NUEVO</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">VER</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">ELIMINAR</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">ACCESO</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">FILTRO(U)</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">OPCIONES</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col">ORDEN</th>
                                    </tr>
                                </thead>
        ...
        <script src="../../../plugins/jquery/seguridad/permiso/jquery.listadoweb-1.2.0.js"></script>
    </body>
