    ...
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "1")
            {
                ...
                Metodos.ValidateAntiXsrfToken("ComisionVendedorList");

                if (!fechainicio.IsInyection() && !fechafin.IsInyection())
                {
                    using (TwoTecnology.Repositorio.ComisionVendedor obj = new TwoTecnology.Repositorio.ComisionVendedor())
                    {
                        respuesta = obj.Load(
                            fechainicio,
                            fechafin,
