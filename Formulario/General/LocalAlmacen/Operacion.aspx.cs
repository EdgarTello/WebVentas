...
namespace TwoTecnology.WebVentas.Formulario.General.LocalAlmacen
{
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string LocalAlmacencodigo = ticket.UserData.Split('|')[10];
            ...
            if (Request.QueryString["ope"] == "2")
            {
                ...
                string principal = Request.QueryString["principal"];

                using (Repositorio.Almacen obj = new TwoTecnology.Repositorio.Almacen())
                {
                    obj.AgregarLocal(idlocal, idalmacen, activo, principal);
