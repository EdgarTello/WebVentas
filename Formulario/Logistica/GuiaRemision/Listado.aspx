<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.Logistica.GuiaRemision.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
            ...
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-end mb-1">
                   <div class="col-auto">
                        ...
                        <input type="hidden" name="hnuevo" id="Hidden1" value="" runat="server"/>
                       ...
                       <input type="hidden" name="hnuevo" id="hnuevo" value="" runat="server"/>
                        <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("GuiaRemisionList") %>" />
                    </div>    

                    <div class="col-12 col-sm-auto">
                        <button id="btnagregar" class="btn btn-primary me-1 mb-1" type="button"><i class="fa-solid fa-plus me-2"></i>Agregar Guia</button>
                        <button class="btn btn-phoenix-secondary text-nowrap px-4" type="button" data-bs-toggle="modal" data-bs-target="#searchFilterModal"><span class="fa-solid fa-filter me-md-2"></span><span class="d-none d-md-inline-block">Filtros</span></button>
                        ...
                        <div class="table-responsive scrollbar mb-3">
                            <div class="col-12">
                                <ul class="nav nav-links mx-n2">
                                    ...
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 2);"><span>Despachado</span><span id="ssolicitado" class="text-body-tertiary fw-semibold"></span></a></li>
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 3);"><span>Seguridad</span><span id="satendido" class="text-body-tertiary fw-semibold"></span></a></li>
                                </ul>
                            </div>
                            <table id="tbldetalle" class="table table-sm fs-9 mb-0 overflow-hidden table-hover">
                                <thead class="text-body bg-body-highlight">
                                    <tr>
                                        ...
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="correlativo">ID</th>
                                        <th class="sort align-middle ps-4" scope="col">MOTIVO</th>
                                        <th class="sort align-middle ps-4" scope="col">ESTADOS</th>
                                        <th class="sort align-middle ps-4" scope="col">SUNAT</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="documento">DOCUMENTO</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="empleado">EMPLEADO</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="clientenumero">CLIENTE</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="fecha">FECHA</th>
                                    </tr>
                                </thead>
                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-9">
                            <div class="mb-1">
                                <div class="row g-2">
                                    <div class="form-floating">
                                        <select class="form-select" id="cbomotivo">
                                        </select>
                              ...
                              <table class="table fs-9 text-body mb-0" id="tblsubdetalle">
                                <thead class="bg-body-secondary">
                                  <tr>
                                    ...
                                    <th class="text-end" scope="col" style="width: 60px;">CODIGO</th>
        ...
        <div class="modal fade" tabindex="-1" id="dialogNuevoModal" aria-labelledby="dialogNuevoModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-scrollable modal-fullscreen-md-down">
            <div class="modal-content">
                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <div class="mb-4">
                                <div class="row g-2">
                                    <div class="form-floating">
                                        <select class="form-select" id="cbomotivo2">
                                        </select>
                                        <label for="cbomotivo2">Motivo</label>
                                    </div>
                                </div>
                            </div>
                       </div>
              ...
              <div class="modal-footer border-0 p-4 pt-0">
                <div class="w-100 d-flex flex-wrap gap-3 border-top border-translucent pt-4">
                  <button class="m-0 btn btn-lg btn-success text-nowrap flex-1" id="btngenerar">Generar GRE <span class="fas fa-chevron-right ms-1 fs-10"></span></button>
                </div>
              </div>
            </div>
          </div>
                                ...
                                <div class="col-12 col-md-auto d-flex">
                                  ...
                                  <div class="timeline-item-bar position-relative me-3 me-md-0" id="linea2">
                                    <div class="icon-item icon-item-sm bg-body-quaternary" data-bs-theme="light" id="dicono2">
                                        <span class="fa-solid fa-truck text-white fs-10" id="sicono2"></span>
                                    </div>
                                  </div>
                                </div>
                                <div class="col">
                                ...
                                <div class="col-12 col-md-auto d-flex">
                                  ...
                                  <div class="timeline-item-bar position-relative me-3 me-md-0" id="linea3">
                                    <div class="icon-item icon-item-sm bg-body-quaternary" data-bs-theme="light" id="dicono3">
                                        <span class="fa-solid fa-car text-white fs-10" id="sicono3"></span>
                                    </div>
                                  </div>
                                </div>
                                <div class="col">
        ...
        <script src="../../../plugins/jquery/logistica/guiaremision/jquery.listadoweb-3.0.5.js"></script>
    </body>
