<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.Logistica.Seguridad.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>   
            ...
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-end mb-1">
                   <div class="col-auto">
                        ...
                        <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("SeguridadList") %>" />
                    </div>    
                            ...
                            <table id="tbldetalle" class="table table-sm fs-9 mb-0 overflow-hidden table-hover">
                                <thead class="text-body bg-body-highlight">
                                    <tr>
                                        ...
                                        <th class="sort align-middle ps-4" scope="col">CONFORMIDAD</th>
        ...
        <div class="modal fade" tabindex="-1" id="dialogNuevoModal" aria-labelledby="dialogNuevoModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-md-down">
            <div class="modal-content">
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                <div class="row g-2 mb-2">
                                    <div class="form-floating">
                                        <select class="form-select" id="cboconformidad">
                                            <option value="1">SI</option>
                                            <option value="0">NO</option>
                                        </select>
                                        <label for="cboconformidad">Conformidad</label>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="form-floating">
                                        <textarea id="observacion" class="form-control mb-3" style="resize:none" rows="4" maxlength="200" placeholder="Observcion"></textarea>
                                    </div>
                                </div>
                            </div>
                       </div>
              ...
              <div class="modal-footer border-0 p-4 pt-0">
                <div class="w-100 d-flex flex-wrap gap-3 border-top border-translucent pt-4">
                  <button class="m-0 btn btn-lg btn-success text-nowrap flex-1" id="btngenerar">Grabar <span class="fas fa-chevron-right ms-1 fs-10"></span></button>
                </div>
              </div>
            </div>
          </div>
        ...
        <script src="../../../plugins/jquery/logistica/seguridad/jquery.listadoweb-3.0.1.js"></script>
    </body>
