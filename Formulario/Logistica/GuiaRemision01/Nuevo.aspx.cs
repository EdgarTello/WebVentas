...
namespace TwoTecnology.WebVentas.Formulario.Logistica.GuiaRemision01
{
    public partial class Nuevo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string opcion = "GREVenta";
            string pagina = "../../Logistica/GuiaRemision01/Nuevo.aspx";
            ...
            hidalmacen.Value = Request.QueryString["idalmacen"].ToString();
            hidmotivo.Value = Request.QueryString["idmotivo"].ToString();
