<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.Logistica.Presentacion.Listado" %>
...
<head runat="server">
    ...
    <title>Listado de Presentación</title>
			...
			<div class="card">
				<div class="card-body">
					<div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="text" class="form-control" id="busqueda" name="busqueda" placeholder="Nombre" required="required" />
                            </div>
                            <div class="col-lg-6">
...
<script src="../../../plugins/jquery-ui/jquery-ui.min.js"></script>../../../plugins/jquery/logistica
...
<script src="../../../plugins/jquery/logistica/presentacion/jquery.listadoweb-1.0.2.js"></script>
<!-- AdminLTE App -->
