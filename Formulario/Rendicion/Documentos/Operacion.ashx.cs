        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (context.Request.Params["ope"] == "2")
                {
                    ...
                    Entity.Rendicion rendicion = JsonConvert.DeserializeObject<Entity.Rendicion>(json);

                    using (Repositorio.Rendicion doc = new TwoTecnology.Repositorio.Rendicion())
                    {
                        //id = doc.Agregar(id, rendicion);
                    }
                }
            }
            catch (Exception ex)
