<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recovery.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Rendicion.Acceso.Recovery" %>
         ...
         <div class="card">
            <div class="card-body login-card-body">
                  ...
                  <div class="input-group mb-3">
                     <input type="text" id="husuario"  name="husuario" class="form-control" runat="server" placeholder="Usuario" maxlength="40" />
                  ...
                  <div class="row">
                    <div class="col-12">
                        <asp:Button ID="btnLogin" ClientIDMode="Static" runat="server" CssClass="btn btn-warning btn-block" OnClick="btnLogin_Click" Text="Recuperar"  />
                     </div>
                  </div>
                 <div class="row">
                     <br />
                 ...
                 <div class="row">
                    <div class="col-12">
                        <asp:Button ID="btnRetornar" ClientIDMode="Static" runat="server" CssClass="btn btn-secondary btn-block" OnClick="btnRetornar_Click" Text="Retornar"  />
                     </div>
                 </div>
