<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.PuntoVenta.Rendicion.Frame.Index" %>
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4 custom_sidebar">
    ...
    <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition">
      ...
      <nav class="mt-2">
        ...
        <!-- Flujo CVC -->
        <% if (ViewState["empresa_tipo"].ToString()=="103")
        {%>
                <li class="nav-item">
                    <a href="../Dashboard/Listado.aspx" class="nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item menu-item">
                            <a href="../../Area/Listado.aspx" class="nav-link">
                                <i class="nav-icon fas fa-box"></i>
                                <p>Area</p>
                            </a>
                        </li>
                        <li class="nav-item menu-item">
                            <a href="../TipoDocumento/Listado.aspx" class="nav-link">
                                <i class="nav-icon fas fa-file"></i>
                                <p>Tipo Dcoumento</p>
                            </a>
                        </li>
                        <li class="nav-item menu-item">
                            <a href="../Canal/Listado.aspx" class="nav-link">
                                <i class="nav-icon fas fa-file"></i>
                                <p>Canales</p>
                            </a>
                        </li>
                ...
                <%if ( this.ViewState["acceso"].ToString() == "Recepcion")
                {%>       
                 ...
                 <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../RecepcionDocumentos/Listado.aspx" class="nav-link" id="frmRendicionDocumentos_recepcionlistado">
                                <i class="nav-icon fas fa-inbox"></i><p>Bandeja</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <%if ( this.ViewState["acceso"].ToString() == "Derivador")
                {%>      
                 <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="nav-icon fas fa-city"></i>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../DerivacionDocumentos/Listado.aspx" class="nav-link" id="frmRendicionDocumentos_derivacionlistado">
                            <i class="nav-icon fas fa-inbox"></i><p>Bandeja</p>
                         </a>
                      </li>
                    </ul>  
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../VencidosDocumentos/Listado.aspx" class="nav-link">
                            <i class="nav-icon fas fa-ambulance text-danger"></i><p>Vencidos</p>
                         </a>
                      </li>
                    </ul>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../RecepcionAvanzado/Listado.aspx" class="nav-link">
                            <i class="nav-icon fas fa-search"></i><p>Avanzado</p>
                         </a>
                      </li>
                    </ul>
                ...
                <li class="nav-item">
                    <a href="../Reporte/Listado.aspx" class="nav-link">
                        <i class="nav-icon fas fa-chart-line"></i><p>Reporte</p>
                    </a>
                </li>
                <%}%>


                <%if ( this.ViewState["acceso"].ToString() == "Administrador" || 
                       this.ViewState["acceso"].ToString() == "Gerencia" ||
                       this.ViewState["acceso"].ToString() == "Operador")
                {%>      
                 <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="nav-icon fas fa-city"></i>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../OperadorDocumentos/Listado.aspx" class="nav-link" id="frmRendicionDocumentos_operadorlistado">
                            <i class="nav-icon fas fa-inbox"></i><p>Entrada</p>
                         </a>
                      </li>
                    </ul>
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../OperadorSalida/Listado.aspx" class="nav-link" id="frmRendicionDocumentos_operadorsalida">
                            <i class="nav-icon fas fa-envelope"></i><p>Salida</p>
                         </a>
                      </li>
                    </ul>

                    <%if ( this.ViewState["jefatura"].ToString() == "1")
                    {%>      
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="../JefaturaDocumentos/Listado.aspx" class="nav-link">
                                    <i class="nav-icon fas fa-cube"></i><p>Revisión</p>
                                </a>
                            </li>
                        </ul>
                ...
                <%if ( (this.ViewState["acceso"].ToString() == "Gerencia" ||
                        this.ViewState["acceso"].ToString() == "Administrador") ||
                       this.ViewState["jefatura"].ToString() == "1")
                {%>     
                    <li class="nav-item">
                        <a href="../VencidosDocumentos/Listado.aspx" class="nav-link">
                            <i class="nav-icon fas fa-ambulance text-danger"></i><p>Vencidos</p>
...
<script>
    $(function () {
        ...
        if (pagina != '') {
            ...
            if (pagina == '1' && tipo=='101') {
                setTimeout(
                    function () {
                        $('#frmgestorlistado').click();
                        //$('#pushmenu').click();
                    }, 500);
            }

            if (pagina == '1' && tipo == '102') {
                setTimeout(
                    function () {
                        $('#frmrendicionlistado').click();
                        //$('#pushmenu').click();
                    }, 500);
            }

            if ((pagina == '2') && tipo == '103') {
                setTimeout(
                    function () {
                        $('#frmRendicionDocumentos_recepcionlistado').click();
                        $('#pushmenu').click();
                    }, 500);
            }

            if ((pagina == '3') && tipo == '103') {
                setTimeout(
                    function () {
                        $('#frmRendicionDocumentos_derivacionlistado').click();
                        $('#pushmenu').click();
                    }, 500);
            }

            if ((pagina == '4') && tipo == '103') {
                setTimeout(
                    function () {
                        $('#frmRendicionDocumentos_operadorlistado').click();
                        $('#pushmenu').click();
                    }, 500);
            }
