<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.S10.OrdenPago.Listado" %>
...
<html lang="en-US" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default">
    ...
    <body>
            ...
            <div class="card-header p-2 border-bottom bg-body">
                <div class="row g-3 justify-content-between align-items-end mb-1">
                   <div class="col-auto">
                        ...
                        <input name="__RequestVerificationToken" type="hidden" value="<%= TwoTecnology.WebVentas.Metodos.GetAntiXsrfToken("OrdenPagoList") %>" />
                    </div>    

                    <div class="col-12 col-sm-auto">
                        <button id="btnsolicitarcheck" class="btn btn-primary" type="button"><i class="fa-solid fa-plus me-2"></i>Solicitar</button>
                        ...
                        <div class="table-responsive scrollbar mb-3">
                            <div class="col-12">
                                <ul class="nav nav-links mx-n2">
                                    <li class="nav-item"><a id="filtradefault" class="sfilter nav-link px-2 py-1 active" aria-current="page" href="#" onclick="return filtrar(this, 1);"><span class="text-secondary">Generado</span><span id="sgenerado" class="text-body-tertiary fw-semibold"></span></a></li>
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 2);"><span class="text-warning">Solicitado</span><span id="ssolicitado" class="text-body-tertiary fw-semibold"></span></a></li>
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 3);"><span class="text-danger">Rechazado</span><span id="srechazado" class="text-body-tertiary fw-semibold"></span></a></li>
                                    <li class="nav-item"><a class="sfilter nav-link px-2 py-1" href="#" onclick="return filtrar(this, 4);"><span class="text-success">Aprobado</span><span id="saprobado" class="text-body-tertiary fw-semibold"></span></a></li>
                                </ul>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <th class="sort text-end align-middle pe-0 ps-4"      scope="col">
                                            <div class="form-check">
                                                <input class="form-check-input" id="chk_all" type="checkbox">
                                            </div>
                                        </th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="pagoid">Número</th>
                                        <th class="sort align-middle ps-4" scope="col" data-sort="descripcion">Operación</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="descripcionempresa">Empresa</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="usuariologin">Usuario</th>
                                        <th class="white-space-nowrap align-middle ps-4" scope="col">Importe</th>
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col" data-sort="fechatrx">F.Doc</th>
                                        <th class="white-space-nowrap align-middle ps-4" scope="col">Situación</th>
                                    </tr>
                                </thead>
        ...
        <div class="modal fade" id="dialogSolicitar" tabindex="-1" role="dialog" aria-labelledby="dialogSolicitarLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header justify-content-between">
                        <h5 class="modal-title" id="dialogSolicitarLabel">Administrador</h5>
                        <button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close">
                            <span class="fas fa-times fs-10 me-1" data-fa-transform="up-1"></span>Close
                        </button>
                    </div>
                    <div class="modal-body">
                        <label>Solicitar aprobacion del pago de los siguientes:</label>
                        <br>
                        <div class="mb-3 flex-1">
                            <table class="table fs-9 text-body mb-0" id="tblsubdetalle02">
                              <thead class="bg-body-secondary">
                                <tr>
                                  <th scope="col" style="width: 24px;"></th>
                                  <th class="text-star" scope="col" style="min-width: 60px;">ROL</th>
                                  <th class="text-star" scope="col" style="min-width: 80px;">NOMBRES Y APELLIDOS</th>
                                  <th class="text-center" scope="col" style="min-width: 100px;">CORREO</th>
                                  <th scope="col" style="width: 24px;"></th>
                                </tr>
                              </thead>
                              <tbody id="tblbodysubdetalle02">
                              </tbody>
                            </table>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex">
                                <button class="btn btn-primary fs-10" type="button" id="btnsolicitar">Enviar<span class="fa-solid fa-paper-plane ms-1"></span></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal fade" id="dialogSeguimiento" tabindex="-1" role="dialog" aria-labelledby="dialogSeguimientoLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label>Seguimiento de aprobaciones:</label>
                        <br>
                        <div class="mb-3 flex-1">
                            <table class="table fs-9 text-body mb-0" id="tblsubdetalle03">
                              <thead class="bg-body-secondary">
                                <tr>
                                  <th scope="col" style="width: 24px;"></th>
                                  <th class="text-star" scope="col" style="min-width: 60px;">ROL</th>
                                  <th class="text-star" scope="col" style="min-width: 80px;">NOMBRES Y APELLIDOS</th>
                                  <th class="text-center" scope="col" style="min-width: 100px;">CORREO</th>
                                  <th class="text-center" scope="col" style="min-width: 100px;">ESTADO</th>
                                  <th scope="col" style="width: 24px;"></th>
                                </tr>
                              </thead>
                              <tbody id="tblbodysubdetalle03">
                              </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-12">
                              <div class="mb-1">
                                  <div class="row g-2">
                                      <div class="form-floating">
                                          <select class="form-select" id="cboempresa">
                                          </select>
        ...
        <div class="modal" id="dialogDetalle" tabindex="-1" role="dialog" aria-labelledby="dialogDetalleLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">           
                        <div class="container-small" id="divpdf">
                          <div class="d-flex justify-content-between align-items-end mb-4">
                            <h2 class="mb-0">Orden de Pago</h2>
                            <div>
                              <button class="btn btn-phoenix-secondary" id="btnpdf"><span class="fa-solid fa-file-pdf me-sm-2"></span><span class="d-none d-sm-inline-block"></span></button>
                            </div>
                          </div>
                              ...
                              <div class="col-12 col-sm-4 col-lg-8">
                                <div class="row g-4 gy-lg-5">
                                  <div class="col-12 col-lg-12">
                                    <h6 class="mb-2 me-3">Usuario :</h6>
                                    <p class="fs-9 text-body-secondary fw-semibold mb-0" id="sordenusuario"></p>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="table-responsive scrollbar">
                              <table class="table fs-9 text-body mb-0" id="tblsubdetalle">
                                <thead class="bg-body-secondary">
                                  <tr>
                                    <th scope="col" style="width: 24px;"></th>
                                    <th class="text-star" scope="col" style="min-width: 60px;">PROVEEDOR</th>
                                    <th class="text-star" scope="col" style="min-width: 80px;">PROYECTO</th>
                                    <th class="text-center" scope="col" style="min-width: 100px;">DOCUMENTO</th>
        ...
        <script src="../../../plugins/jquery/s10/ordenpago/jquery.listadoweb-3.1.7.js"></script>
