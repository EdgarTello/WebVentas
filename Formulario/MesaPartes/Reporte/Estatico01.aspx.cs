...
namespace TwoTecnology.WebVentas.Formulario.MesaPartes.Reporte
{
    public partial class Estatico01 : System.Web.UI.Page
    {
            ...
            string fechafin)
        {
            ...
            ReportViewer01.LocalReport.ReportPath = Server.MapPath("~/Formulario/MesaPartes/Rpt/Estatico01.rdlc");
            ReportViewer01.LocalReport.DataSources.Clear();

            
            ReportDataSource datasource = new ReportDataSource("DataSet1",
                new TwoTecnology.Repositorio.MPDocumento().LoadReporteDocumento(
                ruc,
                local,
                area,
                ope,
