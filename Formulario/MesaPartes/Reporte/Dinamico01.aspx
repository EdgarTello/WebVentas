<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dinamico01.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.Reporte.Dinamico01" %>
        ...
        <tr>
            ...
            <td>
                ...
                <Fields>
                    ...
                    <dx:PivotGridField Area="RowArea" AreaIndex="0" Caption="Local" FieldName="local"
                        ID="PivotGridFieldDocumento" />
                  
                     <dx:PivotGridField Area="ColumnArea" AreaIndex="0" Caption="Area" FieldName="areanombre"
                        ID="PivotGridFieldCategoria" />

                    <dx:PivotGridField Area="DataArea" AreaIndex="0" Caption="Cantidad" FieldName="cantidad"
                        ID="fieldcantidad" CellFormat-FormatString="n0" CellFormat-FormatType="Numeric"/>
                                    

                    <dx:PivotGridField Area="FilterArea" AreaIndex="0" Caption="AÑO" FieldName="fecharegistro"
                        ID="fieldtotalanio" GroupInterval="DateYear" />
                    <dx:PivotGridField Area="FilterArea" AreaIndex="1" Caption="MES" FieldName="fecharegistro"
                        ID="fieldtotalmes" GroupInterval="DateMonth"  />
                    <dx:PivotGridField Area="FilterArea" AreaIndex="2" Caption="DIA" FieldName="fecharegistro"
                        ID="fielddia" GroupInterval="DateDay" />
                  
                   
                    <dx:PivotGridField Area="FilterArea" AreaIndex="3" Caption="Flujo" FieldName="flujonombre"
                        ID="PivotGridFieldLocal" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="4" Caption="Canal" FieldName="canalnombre"
                        ID="PivotGridFieldCaja" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="5" Caption="Operacion" FieldName="openombre"
                        ID="PivotGridFieldMoneda" />

                    <dx:PivotGridField Area="FilterArea" AreaIndex="6" Caption="Etapa" FieldName="etapanombre"
