<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.OperadorRespuesta.Nuevo" %>
...
<body>
                        ...
                        <div class="container-fluid">
                            <div class="row">                                
                                ...
                                <div class="col-7 pl-5">
                                    <div class="row">
                                        <div class="col-6">
                                            <p class="text-primary"><span class="badge rounded-circle bg-info">1°</span>DOCUMENTO DE RESPUESTA</p>
                                        </div>
                                        <div class="col-6">
		    ...
		    <div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
				    ...
				    <div class="modal-body" id="mbody_grabar">
                        <div class="row">
                            <div class="col-12">
                                ¿Esta seguro de adjuntar este documento como respuesta?
                            </div>
                        </div>
                        <div class="row">
                            <br />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="chkcargonotificacion" />
                                    <label class="form-check-label" for="chkcargonotificacion">
                                    Notificarme cuando el cargo sea ingresado
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../../../plugins/jquery/mesapartes/operadorrespuesta/jquery.nuevoweb-1.2.6.js"></script>
