        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (context.Request.Params["ope"] == "1" && 
                        (usuario_acceso=="Operador" || usuario_acceso == "Gerencia"))
                {
                ...
                if (context.Request.Params["ope"] == "101" && 
                    (usuario_acceso == "Derivador" || usuario_acceso == "Operador"|| usuario_acceso == "Gerencia"))
                {
                ...
                if (context.Request.Params["ope"] == "2" && (usuario_acceso == "Operador" || usuario_acceso == "Gerencia"))
                {
                    ...
                    if (mpdocumento.flujo2_aprobacion_directa == "1")
                    {
                    ...
                    using (TwoTecnology.Repositorio.MPDocumento doc = new TwoTecnology.Repositorio.MPDocumento())
                    {
                        if (mpdocumento.id == "0")
                        {
                            id = doc.AgregarSalida(empresaruc,
                            ...
                            //doc.EditarSalida(mpdocumento.id,
                            //    mpdocumento.idarchivo,
                            //    mpdocumento.asunto,
                            //    mpdocumento.clientetipodoc, mpdocumento.clientedocumento, mpdocumento.clientenombre,
                            //    mpdocumento.idtipo, 
                    ...
                    if (mpdocumento.flujo2_aprobacion_directa == "1")
                    {
                        ...
                        {
                            var documento = doc.LoadByCodigo(empresaruc, id, "", "0");

                            doc.JefaturaEtapa(empresaruc,
                                usuario_codigo,
                                id,
                                "120",
                                "0",
                ...
                if (context.Request.Params["ope"] == "2000" && (usuario_acceso == "Operador" || usuario_acceso == "Gerencia"))
                {
