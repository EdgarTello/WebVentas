<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ver.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.OperadorSalida.Ver" %>
...
<body>
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <ul class="nav nav-tabs" id="tabver">
			                  <li class="nav-item"><a href="#salida" class="nav-link" data-target="#salida">Salida</a></li>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-7">                                    
                                            <div class="row justify-content-md-center">
                                                <object id="objpdf_salida" name="objpdf_salida" data="" type="application/pdf" width="100%" height="440px"></object>
                                        ...
                                        <div class="col-5 pl-5">
                                            ...
                                            <div class="row">
                                                <p class="text-primary">DATOS DEL RECEPTOR</p>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="cargo">
                                    <div class="d-flex justify-content-center">
                                        <object id="objpdf_cargo" name="objpdf_cargo" data="" type="application/pdf" width="100%" height="440px"></object>
                                    </div>
                                </div>
    ...
    <script src="../../../plugins/jquery/mesapartes/operadorsalida/jquery.verweb-1.2.8.js"></script>
    <!-- AdminLTE App -->
