<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.Local.Nuevo" %>
...
<head runat="server">
  ...
  <title>Edición de Tipo de Documento</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" id="abreviatura" maxlength="3" class="form-control" required="required" />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4>Informacion de Dirección</h4>
                                </div>
...
<script src="../../../plugins/jquery/mesapartes/local/jquery.nuevoweb-1.0.7.js"></script>
<!-- AdminLTE App -->
