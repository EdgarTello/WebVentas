        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    ViewState["jefatura"] = jefatura;
                    ViewState["personalacargo"] = personalacargo;
                    ...
                    lblnombres.Text = string.Format("Bienvenido {0}!", 
                       ((usuarionombres=="")?Context.User.Identity.Name:usuarionombres));
