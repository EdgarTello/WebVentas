<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.Frame.Index" %>
        ...
        {%>
                ...
                {%>       
                 ...
                 <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="../RecepcionDocumentos/Listado.aspx" class="nav-link" id="frmmesapartes_recepcionlistado">
                ...
                {%>      
                 <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../DerivacionDocumentos/Listado.aspx" class="nav-link" id="frmmesapartes_derivacionlistado">
                            <i class="nav-icon fas fa-inbox"></i><p>Bandeja</p>
                         </a>
                      </li>
                    </ul>  
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../VencidosDocumentos/Listado.aspx" class="nav-link">
                            <i class="nav-icon fas fa-ambulance"></i><p class="text-danger">Vencidos</p>
                         </a>
                      </li>
                    </ul>
                ...
                {%>      
                 <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../OperadorDocumentos/Listado.aspx" class="nav-link" id="frmmesapartes_operadorlistado">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="../OperadorSalida/Listado.aspx" class="nav-link" id="frmmesapartes_operadorsalida">
    ...
    $(function () {
        ...
        if (pagina != '') {
            ...
            if ((pagina == '2') && tipo == '103') {
                setTimeout(
                    function () {
                        $('#frmmesapartes_recepcionlistado').click();
                        $('#pushmenu').click();
                    }, 500);
            }
            ...
            if ((pagina == '3') && tipo == '103') {
                setTimeout(
                    function () {
                        $('#frmmesapartes_derivacionlistado').click();
                        $('#pushmenu').click();
                    }, 500);
            }
            ...
            if ((pagina == '4') && tipo == '103') {
                setTimeout(
                    function () {
                        $('#frmmesapartes_operadorlistado').click();
                        $('#pushmenu').click();
                    }, 500);
            }
