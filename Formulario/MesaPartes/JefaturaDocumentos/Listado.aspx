<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.JefaturaDocumentos.Listado" %>
...
<body>
					...
					<div class="card-body" style="padding: 0.5rem !important;">
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<h1>
										Bandeja de Documentos en Revisión
									</h1>
									...
									<input type="hidden" name="husuario_acceso" id="husuario_acceso" value="" runat="server"/>
								</div>
							</div>
							<div class="row">
								<br />
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<select id="cboetapa" class="form-control" name="cboetapa" runat="server">
										...
										<option value="110">SOLICITUD</option>
										<option value="120">ACEPTADO</option>
										<option value="199">FINALIZADO</option>
									</select>
								</div>
								<div class="col-lg-2">
	...
	<script src="../../../plugins/jquery/mesapartes/jefaturadocumentos/jquery.listadoweb-1.2.6.js"></script>
