<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.JefaturaDocumentos.Nuevo" %>
...
<body>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-5 pl-5">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6">
                                            <select class="form-control" id="clientetipodoc" name="clientetipodoc" disabled="disabled">
                                            </select>
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="text" id="clientedocumento" class="form-control" disabled="disabled" />
                                        </div>
                                    </div>                                  
                                    <div class="row mb-4">
                                        <div class="col-lg-12">
                                            <input type="text" id="clientenombre" class="form-control" disabled="disabled"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-12">
                                            <input type="text" id="asunto" class="form-control" disabled="disabled" />                                        
                                        </div>
                                    </div>
		    ...
		    <div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
				    <div class="modal-header">
					    <h3 class="modal-title" style="color:black">Jefatura</h3>
    ...
    <script src="../../../plugins/jquery/mesapartes/jefaturadocumentos/jquery.nuevoweb-1.2.6.js"></script>
    <!-- AdminLTE App -->
