...
namespace TwoTecnology.WebVentas.Formulario.MesaPartes.JefaturaDocumentos
{
    public partial class Operacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ope"] == "000" && (usuario_acceso == "Gerencia" || usuario_acceso == "Operador"))
            {
            ...
            if (Request.QueryString["ope"] == "001" && (usuario_acceso == "Gerencia" || usuario_acceso == "Operador"))
            {
                string id = Request.QueryString["id"];
