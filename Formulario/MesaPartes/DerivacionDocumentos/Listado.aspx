<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.DerivacionDocumentos.Listado" %>
...
<body>
					...
					<div class="card-body" style="padding: 0.5rem !important;">
						<div class="container-fluid">
										...
										<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
											<div class="btn-group mr-2" role="group" aria-label="Second group">
												<button type="button" class="btn btn-primary active" id="btnnuevo" title="Nuevo">
													<i class="fas fa-file"></i> Registrar
												</button>
										    </div>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-1">
									<select id="cbooperacion" class="form-control" name="cbooperacion" runat="server">
								...
								<div class="col-lg-2">
									<select id="cboetapa" class="form-control" name="cboetapa" runat="server">
										...
										<option value="1" selected="selected">RECEPCIONADO</option>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" style="color:black">Mesa de Partes</h3>
	...
	<script src="../../../plugins/jquery/mesapartes/derivaciondocumentos/jquery.listadoweb-1.2.9.js"></script>
