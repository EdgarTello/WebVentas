<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.DerivacionDocumentos.Nuevo" %>
...
<body>
    <form id="formulario" name="formulario" runat="server" >
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-5 pl-5">
                                            ...
                                            <div class="d-flex flex-row justify-content-end p-1">
										        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                    <div class="btn-group mr-2" role="group" aria-label="First group">
                                                        <a href="#" onclick="derivar();" title="Derivar">
                                                            <i class="fas fa-user-tie fa-2x me-3" style="color: #ff6219;"></i>
                                                        </a>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <p class="text-primary"><span class="badge rounded-circle bg-info">1°</span> DATOS DEL EMISOR</p>
                                    </div>
                                    ...
                                    <div class="row">
                                        <p class="text-primary"><span class="badge rounded-circle bg-info">2°</span> DATOS DEL DOCUMENTO</p>
                                    </div>
        ...
        <div class="modal" id="dialogderivar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		    <div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
				    <div class="modal-header">
					    <h3 class="modal-title" style="color:black">Derivación</h3>
					    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				    </div>
				    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ¿Esta seguro de derivar el documento?
                            </div>
                        </div>
                        <div class="row">
                            <br />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <select id="cbousuario" name="cbousuario" class="form-control"></select>
                            </div>
                        </div>
                        <div class="row">
                            <br />
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" class="btn btn-success" id="btn_pup_grabar" name="btn_pup_grabar" onclick="this.disabled='true';derivar_actualizar();" value="Confirmar" title="Derivar"   />
				    ...
				    <div class="modal-body">
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                               <select class="form-select" id="cboetiqueta" data-placeholder="Etiquetas" multiple>
                               </select>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../../../plugins/jquery/mesapartes/derivaciondocumentos/jquery.nuevoweb-1.2.6.js"></script>
    <!-- AdminLTE App -->
