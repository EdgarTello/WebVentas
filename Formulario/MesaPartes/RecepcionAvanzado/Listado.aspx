<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="TwoTecnology.WebVentas.Formulario.MesaPartes.RecepcionAvanzado.Listado" %>
...
<body>
					...
					<div class="card-body" style="padding: 0.5rem !important;">
						<div class="container-fluid">
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<input type="text" class="form-control" maxlength="100" id="busqueda" name="busqueda" placeholder="BUSQUEDA (5 caracteres min)" />
								</div>
								<div class="col-lg-1">
	...
	<script src="../../../plugins/jquery/mesapartes/recepcionavanzado/jquery.listadoweb-1.2.0.js"></script>
