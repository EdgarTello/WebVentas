...
module.exports = function(options) {
	...
	if (typeof options.element === "undeed" || options.element === null) {
		throw new Error("element required"); 
	}

	if (typeof options.showToolTip !== "undeed") {
		showToolTip = !!options.showToolTip; 
	}

	if (typeof options.step !== "undeed") {
	...
	if (typeof options.disableText !== "undeed") {
		disableText = options.disableText; 
	}else {
		disableText = "{rating}/{maxRating}"; 
	}

	if (typeof options.ratingText !== "undeed") {
	...
	function onStarClick(e) {
		...
		if (typeof callback !== "undeed") {
			isRating = true; 
			myRating = currentRating; 

			if (typeof isBusyText === "undeed") {
