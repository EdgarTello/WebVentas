...
(function () {
    ...
    const read = (element, attr) => {
      ...
      return value === undeed || value === '' ? [] : value.split(' ');
    };
    ...
    const toggle = editor => {
      ...
      let parentNode = dParentElm(editor.selection.getNode(), body);
      parentNode = parentNode !== undeed ? parentNode : body;
